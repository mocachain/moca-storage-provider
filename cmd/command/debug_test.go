...
func TestPutObject(t *testing.T) {
	...
	err := app.Run([]string{"./moca-sp", "debug.put.object", "--file", "./not_exist_file"})
	assert.NotNil(t, err)
	...
	assert.Nil(t, err)
	err = app.Run([]string{"./moca-sp", "debug.put.object", "--file", "./too_large_file"})
	assert.NotNil(t, err)
	...
	assert.Nil(t, err)
	err = app.Run([]string{"./moca-sp", "debug.put.object", "--file", "./normal_file"})
	assert.NotNil(t, err)
