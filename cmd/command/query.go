...
var ListModulesCmd = &cli.Command{
	...
	Name:        "list.modules",
	Usage:       "List the modules in moca storage provider",
	Category:    queryCommands,
	Description: `The list command output the services in moca storage provider.`,
}

var ListErrorsCmd = &cli.Command{
	Action:      listErrorsAction,
	Name:        "list.errors",
	Usage:       "List the predefine errors in moca storage provider",
	Category:    queryCommands,
	Description: `The list command output the services in moca storage provider.`,
}
