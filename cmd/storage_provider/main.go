...
import (
	...
	"github.com/mocachain/moca-storage-provider/cmd/command"
	"github.com/mocachain/moca-storage-provider/cmd/command/bs_data_migration"
	"github.com/mocachain/moca-storage-provider/cmd/utils"
	"github.com/mocachain/moca-storage-provider/core/module"
	"github.com/mocachain/moca-storage-provider/modular/approver"
	"github.com/mocachain/moca-storage-provider/modular/authenticator"
	"github.com/mocachain/moca-storage-provider/modular/blocksyncer"
	"github.com/mocachain/moca-storage-provider/modular/downloader"
	"github.com/mocachain/moca-storage-provider/modular/executor"
	"github.com/mocachain/moca-storage-provider/modular/gater"
	"github.com/mocachain/moca-storage-provider/modular/manager"
	"github.com/mocachain/moca-storage-provider/modular/metadata"
	"github.com/mocachain/moca-storage-provider/modular/p2p"
	"github.com/mocachain/moca-storage-provider/modular/receiver"
	"github.com/mocachain/moca-storage-provider/modular/signer"
	"github.com/mocachain/moca-storage-provider/modular/uploader"
...
var (
	appName  = "moca-sp"
	appUsage = "the Moca Storage Provider command line interface"
)
