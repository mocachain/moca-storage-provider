module github.com/mocachain/moca-storage-provider
...
require (
	...
	github.com/mocachain/moca-common/go v1.1.0
...
replace (
	cosmossdk.io/api => github.com/mocachain/moca-cosmos-sdk/api v1.0.0-audit-fix
	cosmossdk.io/simapp => github.com/mocachain/moca-cosmos-sdk/simapp v1.0.0-audit-fix
	cosmossdk.io/store => github.com/mocachain/moca-cosmos-sdk/store v1.0.0-audit-fix
	cosmossdk.io/x/tx => github.com/mocachain/moca-cosmos-sdk/x/tx v1.0.0-audit-fix
	...
	github.com/fjl/memsize => github.com/fjl/memsize v0.0.2
	github.com/forbole/juno/v4 => github.com/mocachain/moca-juno/v4 v4.0.0-alpha.1
