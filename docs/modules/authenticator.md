...
# Moca Storage Provider Off-Chain Authentication

## Abstract

This document outlines an off-chain authentication specification for moca storage providers (SPs) and clients. The specification includes a full functional workflow and a reference implementation, making it easy for any application integrating with moca SPs to build an off-chain authentication mechanism.

## Motivation

Applications based on the moca chain often need to interact with multiple moca SPs, which are off-chain services that require users to use Ethereum-compatible accounts to represent their identities.
...
2. The **app domain** is `https://moca_app1.domain.com`
...
<div align="left"><img src="https://raw.githubusercontent.com/mocachain/moca-docs/main/static/asset/015-Auth-Update-Key-Metamask.png" width="500" height="100" /></div>
...
--header 'Origin: https://moca_app1.domain.com' \
--header 'X-Gnfd-App-Domain: https://moca_app1.domain.com' \
...
--header 'Authorization: GNFD1-ETH-PERSONAL_SIGN,SignedMsg=https://moca_app1.domain.com wants you to sign in with your Moca account:\n0x3d0a49B091ABF8940AD742c0139416cEB30CdEe0\n\nRegister your identity public key 4db642fe6bc2ceda2e002feb8d78dfbcb2879d8fe28e84e02b7a940bc0440083\n\nURI: https://moca_app1.domain.com\nVersion: 1\nChain ID: 5600\nIssued At: 2023-04-24T16:25:24Z\nExpiration Time: 2023-04-28T16:25:24Z'
```
...
[Sample Code to generate EdDSA Signaure For Moca GNFD2-EdDSA AuthType](https://github.com/mocachain/moca-go-sdk/blob/a21d3b5eb75a211266105ea78ad1c76fcdc87c4d/client/api_client.go#L675C2-L685C3)
