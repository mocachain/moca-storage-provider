...
- [Lifecycle Code Snippet](https://github.com/mocachain/moca-storage-provider/blob/master/core/lifecycle/lifecycle.go)
...
- [Modular Code Snippet](https://github.com/mocachain/moca-storage-provider/blob/master/core/module/modular.go)
