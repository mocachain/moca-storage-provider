...
An object represents a fundamental unit of storage in Moca, BSDB object table consists of only associated metadata synced from chain side.
...
A bucket serves as a logical container for storing objects in Moca.
