...
This API is used to upload an object to Moca SP. It serves for two types of upload, either a new object which is just created or to update an existing object. 
...
| -------------------------- | ----------------------------------- |
| Host(virtual-hosted-style) | BucketName.devnet-sp*.mocachain.org |
...
The request body is a binary data that you want to store in Moca SP.

## Request Syntax

```HTTP
PUT /ObjectName HTTP/1.1
Host: BucketName.devnet-sp*.mocachain.org
...
Host: myBucket.devnet-sp*.mocachain.org
...
This API is used to delegate upload an object to Moca SP. It serves for two types of upload, either a new object which is just created or to update an existing object.
And it supports both `virtual-hosted-style` and `path-style` requests.
...
This API is used to create an folder to Moca SP. It serves for two types of upload.
And it supports both `virtual-hosted-style` and `path-style` requests.
