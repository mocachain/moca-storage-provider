...
```js
var app_domain = "https://moca.dapp.cc"
...
var sp_name1 = "SP_001" // SP name, can be found in https://mocascan.com

var sp_addr2 = "0x20Bb76D063a6d2B18B6DaBb2aC985234a4B9eDe0"   // SP operator address
var sp_name2 = "SP_002" // SP name, can be found in https://mocascan.com

var unSignedMsgTemplate = 
`${app_domain} wants you to sign in with your Moca account:
${account_address}
...
Origin: https://moca.dapp.cc
X-Gnfd-App-Domain: https://moca.dapp.cc
