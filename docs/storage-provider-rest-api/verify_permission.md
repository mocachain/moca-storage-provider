...
| action        | [Action](#action) | yes      | action defines the operations you can execute in moca storage network |
...
```HTTP
GET / HTTP/1.1
Host: devnet-sp*.mocachain.org/permission/:operator/:bucket/:action?object=object
```
...
```HTTP
GET / HTTP/1.1
Host: devnet-sp1.mocachain.org/permission/0x9d90A123c3A559a295fa99cCbC82b5ad2C33196B/asnnv/6?object=obgeio5g3y
