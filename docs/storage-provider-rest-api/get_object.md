...
This API is used to download an object from Moca SP. And it supports both `virtual-hosted-style` and `path-style` requests.
...
Host: myBucket.devnet-sp1.mocachain.org
