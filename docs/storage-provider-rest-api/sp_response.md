...
| 400              | 50046      | Gateway                | this signed request was already used, sign a fresh one                                                                                                                  |
| 400              | 50047      | Gateway                | The X-Gnfd-Nonce header is required by this gateway                                                                                                                     |
| 400              | 50048      | Gateway                | The X-Gnfd-Nonce header must be exactly 16 random bytes encoded as hexadecimal                                                                                          |
| 500              | 50049      | Gateway                | unable to claim the signed request nonce                                                                                                                                 |
