...
import (
	...
	types3 "github.com/mocachain/moca-storage-provider/store/types"
	resource "github.com/mocachain/moca/v2/types/resource"
	types2 "github.com/mocachain/moca/v2/x/payment/types"
	types4 "github.com/mocachain/moca/v2/x/permission/types"
	types5 "github.com/mocachain/moca/v2/x/sp/types"
...
type Bucket struct {
	...
	StorageSize string `protobuf:"bytes,10,opt,name=storage_size,json=storageSize,proto3" json:"storage_size,omitempty"`
	// off_chain_status defines the status of a bucket in the off-chain storage
	OffChainStatus int32 `protobuf:"varint,11,opt,name=off_chain_status,json=offChainStatus,proto3" json:"off_chain_status,omitempty"`
}
...
func (m *Bucket) GetStorageSize() string {
	if m != nil {
...
func (m *Bucket) GetOffChainStatus() int32 {
	if m != nil {
		return m.OffChainStatus
	}
	return 0
}
...
type ObjectDetails struct {
	...
	// gvg defines a global virtual group consists of one primary SP (SP) and
...
type VGFInfoBucket struct {
	...
	// storage_size defines the size of bucket
	StorageSize string `protobuf:"bytes,11,opt,name=storage_size,json=storageSize,proto3" json:"storage_size,omitempty"`
	// off_chain_status defines the status of a bucket in the off-chain storage
	OffChainStatus int32 `protobuf:"varint,12,opt,name=off_chain_status,json=offChainStatus,proto3" json:"off_chain_status,omitempty"`
}
...
func (m *VGFInfoBucket) GetStorageSize() string {
	if m != nil {
		return m.StorageSize
	}
	return ""
...
func (m *VGFInfoBucket) GetOffChainStatus() int32 {
	if m != nil {
		return m.OffChainStatus
	}
	return 0
...
// GfSpGetUserBucketsRequest is request type for the GfSpGetUserBuckets RPC
// method.
type GfSpGetUserBucketsRequest struct {
	// account_id is the account address of user
	AccountId string `protobuf:"bytes,1,opt,name=account_id,json=accountId,proto3" json:"account_id,omitempty"`
	// include_removed indicates whether this request can get the removed buckets
	// information
...
// GfSpGetUserBucketsResponse is response type for the GfSpGetUserBuckets RPC
// method.
...
// GfSpListObjectsByBucketNameRequest is request type for the
// GfSpListObjectsByBucketName RPC method
type GfSpListObjectsByBucketNameRequest struct {
	...
	// continuation_token indicates that the list is being continued on this
	// bucket with a token
	...
	// include_removed indicates whether this request can get the removed objects
	// information
...
// GfSpListObjectsByBucketNameResponse is response type for the
// GfSpListObjectsByBucketName RPC method.
type GfSpListObjectsByBucketNameResponse struct {
	...
	// max_keys sets the maximum number of keys returned in the response
	MaxKeys uint64 `protobuf:"varint,3,opt,name=max_keys,json=maxKeys,proto3" json:"max_keys,omitempty"`
	// is_truncated set to false if all of the results were returned. set to true
	// if more keys are available to return
	IsTruncated bool `protobuf:"varint,4,opt,name=is_truncated,json=isTruncated,proto3" json:"is_truncated,omitempty"`
	// next_continuation_token is sent when is_truncated is true, which means
	...
	// common_prefixes a list of strings representing common prefixes.
	// common_prefixes are those parts of object key names that fall between the
...
// GfSpGetBucketByBucketNameRequest is request type for the
// GfSpGetBucketByBucketName RPC method
type GfSpGetBucketByBucketNameRequest struct {
	// bucket_name is the name of the bucket
	BucketName string `protobuf:"bytes,1,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"`
	// include_private indicates whether this request can get the private buckets
	// information
...
// GfSpGetBucketByBucketNameResponse is response type for the
// GfSpGetBucketByBucketName RPC method.
...
// GfSpGetBucketByBucketIDRequest is request type for the
// GfSpGetBucketByBucketID RPC method
...
// GfSpGetBucketByBucketIDResponse is response type for the
// GfSpGetBucketByBucketID RPC method.
...
// GfSpListDeletedObjectsByBlockNumberRangeRequest is request type for the
// GfSpListDeletedObjectsByBlockNumberRange RPC method
type GfSpListDeletedObjectsByBlockNumberRangeRequest struct {
	// start_block_number defines the start of range
	// [start_block_number, end_block_number], start_block_number >
	...
	// include_private indicates whether this request can get the private objects
	// information
...
// GfSpListDeletedObjectsByBlockNumberRangeResponse is response type for the
// GfSpListDeletedObjectsByBlockNumberRange RPC method.
...
// GfSpGetUserBucketsCountRequest is request type for the
// GfSpGetUserBucketsCount RPC method.
...
// GfSpGetUserBucketsCountResponse is response type for the
// GfSpGetUserBucketsCount RPC method.
...
// GfSpListExpiredBucketsBySpRequest is the request type for the
// GfSpListExpiredBucketsBySp RPC method.
...
// GfSpListExpiredBucketsBySpResponse is the response type for the
// GfSpListExpiredBucketsBySp RPC method.
...
// GfSpGetObjectMetaResponse is response type for the GfSpGetObjectMeta RPC
// method.
...
// GfSpGetPaymentByBucketNameRequest is request type for the
// GfSpGetPaymentByBucketName RPC method
...
// GfSpGetPaymentByBucketNameResponse is response type for the
// GfSpGetPaymentByBucketName RPC method.
...
// GfSpGetPaymentByBucketIDRequest is request type for the
// GfSpGetPaymentByBucketID RPC method
...
// GfSpGetPaymentByBucketIDResponse is response type for the
// GfSpGetPaymentByBucketID RPC method.
...
// GfSpGetBucketMetaResponse is response type for the GfSpGetBucketMeta RPC
// method
...
// GfSpGetEndpointBySpIDRequest is request type for the GfSpGetEndpointBySpID
// RPC method
...
// GfSpGetEndpointBySpIDResponse is response type for the GfSpGetEndpointBySpID
// RPC method.
...
// GfSpGetBucketReadQuotaRequest is request type for the GfSpGetBucketReadQuota
// RPC method.
type GfSpGetBucketReadQuotaRequest struct {
	// bucket info from the moca chain
	BucketInfo *types.BucketInfo `protobuf:"bytes,1,opt,name=bucket_info,json=bucketInfo,proto3" json:"bucket_info,omitempty"`
...
// GfSpGetBucketReadQuotaResponse is response type for the
// GfSpGetBucketReadQuota RPC method.
type GfSpGetBucketReadQuotaResponse struct {
	...
	// charged_quota_size is the moca chain bucket info's read quota size
	...
	SpMonthlyFreeQuotaSize uint64 `protobuf:"varint,6,opt,name=sp_monthly_free_quota_size,json=spMonthlyFreeQuotaSize,proto3" json:"sp_monthly_free_quota_size,omitempty"`
	// monthly_free_quota_consume_siz is currently consumed monthly size
	MonthlyFreeQuotaConsumeSize uint64 `protobuf:"varint,7,opt,name=monthly_free_quota_consume_size,json=monthlyFreeQuotaConsumeSize,proto3" json:"monthly_free_quota_consume_size,omitempty"`
	// total_consume_size is currently consumed total size
	TotalConsumeSize uint64 `protobuf:"varint,8,opt,name=total_consume_size,json=totalConsumeSize,proto3" json:"total_consume_size,omitempty"`
	// remain_quota_size is currently remaining quota
	RemainQuotaSize uint64 `protobuf:"varint,9,opt,name=remain_quota_size,json=remainQuotaSize,proto3" json:"remain_quota_size,omitempty"`
}
...
func (m *GfSpGetBucketReadQuotaResponse) GetSpMonthlyFreeQuotaSize() uint64 {
	if m != nil {
		return m.SpMonthlyFreeQuotaSize
	}
	return 0
}

func (m *GfSpGetBucketReadQuotaResponse) GetMonthlyFreeQuotaConsumeSize() uint64 {
	if m != nil {
		return m.MonthlyFreeQuotaConsumeSize
	}
	return 0
}

func (m *GfSpGetBucketReadQuotaResponse) GetTotalConsumeSize() uint64 {
	if m != nil {
		return m.TotalConsumeSize
	}
	return 0
}

func (m *GfSpGetBucketReadQuotaResponse) GetRemainQuotaSize() uint64 {
	if m != nil {
		return m.RemainQuotaSize
	}
	return 0
}

// GfSpGetBucketReadQuotaCountRequest is request type for the
// GfSpGetBucketReadQuotaCount RPC method.
type GfSpGetBucketReadQuotaCountRequest struct {
	// year_month is the query bucket quota's month, like "2023-03"
	YearMonth string `protobuf:"bytes,1,opt,name=year_month,json=yearMonth,proto3" json:"year_month,omitempty"`
}

func (m *GfSpGetBucketReadQuotaCountRequest) Reset()         { *m = GfSpGetBucketReadQuotaCountRequest{} }
func (m *GfSpGetBucketReadQuotaCountRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBucketReadQuotaCountRequest) ProtoMessage()    {}
func (*GfSpGetBucketReadQuotaCountRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{32}
}
func (m *GfSpGetBucketReadQuotaCountRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBucketReadQuotaCountRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBucketReadQuotaCountRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBucketReadQuotaCountRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBucketReadQuotaCountRequest.Merge(m, src)
}
func (m *GfSpGetBucketReadQuotaCountRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBucketReadQuotaCountRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBucketReadQuotaCountRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBucketReadQuotaCountRequest proto.InternalMessageInfo

func (m *GfSpGetBucketReadQuotaCountRequest) GetYearMonth() string {
	if m != nil {
		return m.YearMonth
	}
	return ""
...
// GfSpListBucketReadQuotaResponse is response type for the
// GfSpGetBucketReadQuotaCountResponse RPC method.
type GfSpGetBucketReadQuotaCountResponse struct {
	Err   *gfsperrors.GfSpError `protobuf:"bytes,1,opt,name=err,proto3" json:"err,omitempty"`
	Count int64                 `protobuf:"varint,2,opt,name=count,proto3" json:"count,omitempty"`
}

func (m *GfSpGetBucketReadQuotaCountResponse) Reset()         { *m = GfSpGetBucketReadQuotaCountResponse{} }
func (m *GfSpGetBucketReadQuotaCountResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBucketReadQuotaCountResponse) ProtoMessage()    {}
func (*GfSpGetBucketReadQuotaCountResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{33}
}
func (m *GfSpGetBucketReadQuotaCountResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBucketReadQuotaCountResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBucketReadQuotaCountResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBucketReadQuotaCountResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBucketReadQuotaCountResponse.Merge(m, src)
}
func (m *GfSpGetBucketReadQuotaCountResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBucketReadQuotaCountResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBucketReadQuotaCountResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBucketReadQuotaCountResponse proto.InternalMessageInfo

func (m *GfSpGetBucketReadQuotaCountResponse) GetErr() *gfsperrors.GfSpError {
	if m != nil {
		return m.Err
	}
	return nil
...
func (m *GfSpGetBucketReadQuotaCountResponse) GetCount() int64 {
	if m != nil {
		return m.Count
	}
	return 0
...
// GfSpListBucketReadQuotaRequest is request type for the
// GfSpListBucketReadQuota RPC method.
type GfSpListBucketReadQuotaRequest struct {
	// year_month is the query bucket quota's month, like "2023-03"
	YearMonth string `protobuf:"bytes,1,opt,name=year_month,json=yearMonth,proto3" json:"year_month,omitempty"`
...
func (m *GfSpListBucketReadQuotaRequest) Reset()         { *m = GfSpListBucketReadQuotaRequest{} }
func (m *GfSpListBucketReadQuotaRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpListBucketReadQuotaRequest) ProtoMessage()    {}
func (*GfSpListBucketReadQuotaRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{34}
}
func (m *GfSpListBucketReadQuotaRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListBucketReadQuotaRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListBucketReadQuotaRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListBucketReadQuotaRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListBucketReadQuotaRequest.Merge(m, src)
}
func (m *GfSpListBucketReadQuotaRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListBucketReadQuotaRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListBucketReadQuotaRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListBucketReadQuotaRequest proto.InternalMessageInfo

func (m *GfSpListBucketReadQuotaRequest) GetYearMonth() string {
	if m != nil {
		return m.YearMonth
	}
	return ""
...
func (m *GfSpListBucketReadQuotaRequest) GetOffset() uint32 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *GfSpListBucketReadQuotaRequest) GetLimit() uint32 {
	if m != nil {
		return m.Limit
	}
	return 0
...
type BucketReadQuotaRecord struct {
	// bucket_name
	BucketName string `protobuf:"bytes,1,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"`
	// bucket_id
...
func (m *BucketReadQuotaRecord) Reset()         { *m = BucketReadQuotaRecord{} }
func (m *BucketReadQuotaRecord) String() string { return proto.CompactTextString(m) }
func (*BucketReadQuotaRecord) ProtoMessage()    {}
func (*BucketReadQuotaRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{35}
}
func (m *BucketReadQuotaRecord) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *BucketReadQuotaRecord) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BucketReadQuotaRecord.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *BucketReadQuotaRecord) XXX_Merge(src proto.Message) {
	xxx_messageInfo_BucketReadQuotaRecord.Merge(m, src)
}
func (m *BucketReadQuotaRecord) XXX_Size() int {
	return m.Size()
}
func (m *BucketReadQuotaRecord) XXX_DiscardUnknown() {
	xxx_messageInfo_BucketReadQuotaRecord.DiscardUnknown(m)
}

var xxx_messageInfo_BucketReadQuotaRecord proto.InternalMessageInfo

func (m *BucketReadQuotaRecord) GetBucketName() string {
	if m != nil {
		return m.BucketName
	}
	return ""
...
func (m *BucketReadQuotaRecord) GetBucketId() uint64 {
	if m != nil {
		return m.BucketId
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetSpFreeQuotaSize() uint64 {
	if m != nil {
		return m.SpFreeQuotaSize
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetConsumedSize() uint64 {
	if m != nil {
		return m.ConsumedSize
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetFreeQuotaConsumeSize() uint64 {
	if m != nil {
		return m.FreeQuotaConsumeSize
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetSpMonthlyFreeQuotaSize() uint64 {
	if m != nil {
		return m.SpMonthlyFreeQuotaSize
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetMonthlyFreeQuotaConsumeSize() uint64 {
	if m != nil {
		return m.MonthlyFreeQuotaConsumeSize
	}
	return 0
...
func (m *BucketReadQuotaRecord) GetTotalConsumeSize() uint64 {
	if m != nil {
		return m.TotalConsumeSize
	}
	return 0
...
// GfSpListBucketReadQuotaResponse is response type for the
// GfSpListBucketReadQuota RPC method.
type GfSpListBucketReadQuotaResponse struct {
	Err    *gfsperrors.GfSpError    `protobuf:"bytes,1,opt,name=err,proto3" json:"err,omitempty"`
	Result []*BucketReadQuotaRecord `protobuf:"bytes,2,rep,name=result,proto3" json:"result,omitempty"`
}

func (m *GfSpListBucketReadQuotaResponse) Reset()         { *m = GfSpListBucketReadQuotaResponse{} }
func (m *GfSpListBucketReadQuotaResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpListBucketReadQuotaResponse) ProtoMessage()    {}
func (*GfSpListBucketReadQuotaResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{36}
}
func (m *GfSpListBucketReadQuotaResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListBucketReadQuotaResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListBucketReadQuotaResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListBucketReadQuotaResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListBucketReadQuotaResponse.Merge(m, src)
}
func (m *GfSpListBucketReadQuotaResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListBucketReadQuotaResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListBucketReadQuotaResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListBucketReadQuotaResponse proto.InternalMessageInfo

func (m *GfSpListBucketReadQuotaResponse) GetErr() *gfsperrors.GfSpError {
	if m != nil {
		return m.Err
	}
	return nil
...
func (m *GfSpListBucketReadQuotaResponse) GetResult() []*BucketReadQuotaRecord {
	if m != nil {
		return m.Result
	}
	return nil
...
// GfSpGetLatestBucketReadQuotaRequest is request type for the
// GfSpGetLatestBucketReadQuota RPC method.
type GfSpGetLatestBucketReadQuotaRequest struct {
	// bucket id from the moca chain
...
// GfSpGetLatestBucketReadQuotaResponse is response type for the
// GfSpGetLatestBucketReadQuota RPC method.
...
// ListBucketReadRecordRequest is request type for the ListBucketReadRecord RPC
// method.
type GfSpListBucketReadRecordRequest struct {
	// bucket info from the moca chain
	BucketInfo *types.BucketInfo `protobuf:"bytes,1,opt,name=bucket_info,json=bucketInfo,proto3" json:"bucket_info,omitempty"`
	// start_timestamp_us is the list request's left side, like
	...
	// start_timestamp_us is the list request's right side, like
	// [start_timestamp_us, end_timestamp_us)
...
// ListBucketReadRecordResponse is response type for the ListBucketReadRecord
// RPC method.
type GfSpListBucketReadRecordResponse struct {
	...
	// next_start_timestamp_us is used to fetch next batch, When the list is
	// completed, it is 0.
...
// QueryUploadProgressRequest is request type for the QueryObjectPutState RPC
// method.
...
// QueryUploadProgressResponse is response type for the QueryObjectPutState RPC
// method.
...
// GfSpQueryResumableUploadSegmentRequest is request type for the
// QueryObjectPutState RPC method.
...
// GfSpQueryResumableUploadSegmentResponse is response type for the
// QueryObjectPutState RPC method.
...
type GfSpGetGroupListRequest struct {
	...
	// limit defines the maximum number of results that should be returned in
	// response
	Limit int64 `protobuf:"varint,4,opt,name=limit,proto3" json:"limit,omitempty"`
	// offset defines the position in the list from where to start returning
	// results
	Offset int64 `protobuf:"varint,5,opt,name=offset,proto3" json:"offset,omitempty"`
	// include_removed indicates whether this request can get the removed groups
	// information
...
// GfSpGetBucketByIDsRequest is request type for the GfSpListBucketsByIDs RPC
// method
...
// GfSpGetBucketByIDsResponse is response type for the GfSpListBucketsByIDs RPC
// method.
...
// GfSpListObjectsByIDsRequest is request type for the GfSpListObjectsByIDs RPC
// method
...
// GfSpListObjectsByIDsRequest is response type for the GfSpListObjectsByIDs RPC
// method.
...
// GfSpListObjectsByIDsInternalRequest is the request type for the
// GfSpListObjectsByIDsInternal RPC method.
type GfSpListObjectsByIDsInternalRequest struct {
	// object_ids is the list of unique identifier for objects
	ObjectIds []uint64 `protobuf:"varint,1,rep,packed,name=object_ids,json=objectIds,proto3" json:"object_ids,omitempty"`
	// include_removed indicates whether this request can get the removed objects
	// information
...
func (m *GfSpListObjectsByIDsInternalRequest) Reset()         { *m = GfSpListObjectsByIDsInternalRequest{} }
func (m *GfSpListObjectsByIDsInternalRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpListObjectsByIDsInternalRequest) ProtoMessage()    {}
func (*GfSpListObjectsByIDsInternalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{54}
}
func (m *GfSpListObjectsByIDsInternalRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListObjectsByIDsInternalRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListObjectsByIDsInternalRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListObjectsByIDsInternalRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListObjectsByIDsInternalRequest.Merge(m, src)
}
func (m *GfSpListObjectsByIDsInternalRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListObjectsByIDsInternalRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListObjectsByIDsInternalRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListObjectsByIDsInternalRequest proto.InternalMessageInfo

func (m *GfSpListObjectsByIDsInternalRequest) GetObjectIds() []uint64 {
	if m != nil {
		return m.ObjectIds
	}
	return nil
...
func (m *GfSpListObjectsByIDsInternalRequest) GetIncludeRemoved() bool {
	if m != nil {
		return m.IncludeRemoved
	}
	return false
...
// GfSpListObjectsByIDsInternalResponse is the response type for the
// GfSpListObjectsByIDsInternal RPC method.
type GfSpListObjectsByIDsInternalResponse struct {
	// objects defines the information of a object map
	Objects map[uint64]*Object `protobuf:"bytes,1,rep,name=objects,proto3" json:"objects,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}

func (m *GfSpListObjectsByIDsInternalResponse) Reset()         { *m = GfSpListObjectsByIDsInternalResponse{} }
func (m *GfSpListObjectsByIDsInternalResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpListObjectsByIDsInternalResponse) ProtoMessage()    {}
func (*GfSpListObjectsByIDsInternalResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{55}
}
func (m *GfSpListObjectsByIDsInternalResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListObjectsByIDsInternalResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListObjectsByIDsInternalResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListObjectsByIDsInternalResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListObjectsByIDsInternalResponse.Merge(m, src)
}
func (m *GfSpListObjectsByIDsInternalResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListObjectsByIDsInternalResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListObjectsByIDsInternalResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListObjectsByIDsInternalResponse proto.InternalMessageInfo

func (m *GfSpListObjectsByIDsInternalResponse) GetObjects() map[uint64]*Object {
	if m != nil {
		return m.Objects
	}
	return nil
...
// GfSpVerifyPermissionByIDRequest is request type for the
// GfSpVerifyPermissionByID RPC method
type GfSpVerifyPermissionByIDRequest struct {
	...
	ResourceType resource.ResourceType `protobuf:"varint,2,opt,name=resource_type,json=resourceType,proto3,enum=moca.resource.ResourceType" json:"resource_type,omitempty"`
	...
	ActionType types4.ActionType `protobuf:"varint,4,opt,name=action_type,json=actionType,proto3,enum=moca.permission.ActionType" json:"action_type,omitempty"`
}
...
// GfSpVerifyPermissionByIDResponse is response type for the
// GfSpVerifyPermissionByID RPC method
type GfSpVerifyPermissionByIDResponse struct {
	// effect define the effect of the operation permission, include Allow or deny
	Effect types4.Effect `protobuf:"varint,1,opt,name=effect,proto3,enum=moca.permission.Effect" json:"effect,omitempty"`
}
...
// GfSpListVirtualGroupFamiliesBySpIDRequest is request type for the
// GfSpListVirtualGroupFamilies RPC method
...
// GfSpListVirtualGroupFamiliesBySpIDResponse is response type for the
// GfSpListVirtualGroupFamilies RPC method
...
// GfSpGetGlobalVirtualGroupByGvgIDRequest is request type for the
// GfSpQueryGlobalVirtualGroup RPC method
...
// GfSpGetGlobalVirtualGroupByGvgIDResponse is response type for the
// GfSpQueryGlobalVirtualGroup RPC method
type GfSpGetGlobalVirtualGroupByGvgIDResponse struct {
	// global_virtual_group defines a global virtual group consists of one primary
	// SP (SP) and multiple secondary SP
...
// GfSpGetVirtualGroupFamilyRequest is request type for the
// GfSpGetVirtualGroupFamily RPC method
...
// GfSpGetVirtualGroupFamilyResponse is response type for the
// GfSpGetVirtualGroupFamily RPC method
...
// GfSpGetGlobalVirtualGroupRequest is request type for the
// GfSpGetGlobalVirtualGroup RPC method
...
// GfSpGetGlobalVirtualGroupResponse is response type for the
// GfSpGetGlobalVirtualGroup RPC method
...
// GfSpListObjectsInGVGRequest is request type for the GfSpListObjectsInGVG RPC
// method
type GfSpListObjectsInGVGRequest struct {
	...
	// defines the number of results that should be returned in response, the
	// maximum is 1000, default 50
...
// GfSpListObjectsInGVGResponse is response type for the GfSpListObjectsInGVG
// RPC method
...
// GfSpListObjectsInGVGAndBucketRequest is request type for the
// GfSpListObjectsInGVGAndBucket RPC method
...
// GfSpListObjectsInGVGAndBucketResponse is response type for the
// GfSpListObjectsInGVGAndBucket RPC method
...
// GfSpListObjectByGVGAndBucketForGCRequest is request type for the
// GfSpListObjectByGVGAndBucketForGC RPC method
type GfSpListObjectsByGVGAndBucketForGCRequest struct {
	// dst_gvg_id defines the destination of gvg id
	DstGvgId uint32 `protobuf:"varint,1,opt,name=dst_gvg_id,json=dstGvgId,proto3" json:"dst_gvg_id,omitempty"`
	// bucket_id is the unique identification for bucket
	BucketId uint64 `protobuf:"varint,2,opt,name=bucket_id,json=bucketId,proto3" json:"bucket_id,omitempty"`
	// start_after is where you want to start listing from
	StartAfter uint64 `protobuf:"varint,3,opt,name=start_after,json=startAfter,proto3" json:"start_after,omitempty"`
...
func (m *GfSpListObjectsByGVGAndBucketForGCRequest) GetDstGvgId() uint32 {
	if m != nil {
		return m.DstGvgId
	}
	return 0
...
// GfSpListObjectByGVGAndBucketForGCResponse is response type for the
// GfSpListObjectByGVGAndBucketForGC RPC method
...
// GfSpListMigrateBucketEventsRequest is request type for the
// GfSpListMigrateBucketEvents RPC method
...
// GfSpListMigrateBucketEventsResponse is response type for the
// GfSpListMigrateBucketEvents RPC method
...
// GfSpListCompleteMigrationBucketEventsRequest is request type for the
// GfSpListCompleteMigrationBucketEvents RPC method
type GfSpListCompleteMigrationBucketEventsRequest struct {
	// block_id is the unique identification for block
	BlockId uint64 `protobuf:"varint,1,opt,name=block_id,json=blockId,proto3" json:"block_id,omitempty"`
	// src_sp_id is the unique identification for sp
	SrcSpId uint32 `protobuf:"varint,2,opt,name=src_sp_id,json=srcSpId,proto3" json:"src_sp_id,omitempty"`
}

func (m *GfSpListCompleteMigrationBucketEventsRequest) Reset() {
	*m = GfSpListCompleteMigrationBucketEventsRequest{}
}
func (m *GfSpListCompleteMigrationBucketEventsRequest) String() string {
	return proto.CompactTextString(m)
}
func (*GfSpListCompleteMigrationBucketEventsRequest) ProtoMessage() {}
func (*GfSpListCompleteMigrationBucketEventsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{75}
}
func (m *GfSpListCompleteMigrationBucketEventsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListCompleteMigrationBucketEventsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListCompleteMigrationBucketEventsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListCompleteMigrationBucketEventsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListCompleteMigrationBucketEventsRequest.Merge(m, src)
}
func (m *GfSpListCompleteMigrationBucketEventsRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListCompleteMigrationBucketEventsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListCompleteMigrationBucketEventsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListCompleteMigrationBucketEventsRequest proto.InternalMessageInfo

func (m *GfSpListCompleteMigrationBucketEventsRequest) GetBlockId() uint64 {
	if m != nil {
		return m.BlockId
	}
	return 0
...
// GfSpListCompleteMigrationBucketEventsResponse is response type for the
// GfSpListCompleteMigrationBucketEvents RPC method
...
func (m *GfSpListCompleteMigrationBucketEventsResponse) Reset() {
	*m = GfSpListCompleteMigrationBucketEventsResponse{}
}
func (m *GfSpListCompleteMigrationBucketEventsResponse) String() string {
	return proto.CompactTextString(m)
}
func (*GfSpListCompleteMigrationBucketEventsResponse) ProtoMessage() {}
func (*GfSpListCompleteMigrationBucketEventsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{76}
}
func (m *GfSpListCompleteMigrationBucketEventsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpListCompleteMigrationBucketEventsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpListCompleteMigrationBucketEventsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpListCompleteMigrationBucketEventsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpListCompleteMigrationBucketEventsResponse.Merge(m, src)
}
func (m *GfSpListCompleteMigrationBucketEventsResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpListCompleteMigrationBucketEventsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpListCompleteMigrationBucketEventsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpListCompleteMigrationBucketEventsResponse proto.InternalMessageInfo

func (m *GfSpListCompleteMigrationBucketEventsResponse) GetCompleteEvents() []*types.EventCompleteMigrationBucket {
	if m != nil {
...
// GfSpListSwapOutEventsRequest is request type for the GfSpListSwapOutEvents
// RPC method
...
// GfSpListSwapOutEventsResponse is response type for the GfSpListSwapOutEvents
// RPC method
...
// GfSpListGlobalVirtualGroupsBySecondarySPRequest is request type for the
// GfSpListGlobalVirtualGroupsBySecondarySP RPC method
...
// GfSpListGlobalVirtualGroupsBySecondarySPResponse is response type for the
// GfSpListGlobalVirtualGroupsBySecondarySP RPC method
...
// GfSpListGlobalVirtualGroupsByBucketRequest is request type for the
// ListGlobalVirtualGroupsByBucket RPC method
...
// GfSpListGlobalVirtualGroupsByBucketResponse is response type for the
// ListGlobalVirtualGroupsByBucket RPC method
...
// GfSpListSpExitEventsRequest is request type for the GfSpListSPExitEvents RPC
// method
...
// GfSpListSpExitEventsResponse is response type for the GfSpListSPExitEvents
// RPC method
...
// GfSpPrimarySpIncomeDetailsRequest is request type for the
// GfSpPrimarySpIncomeDetails RPC method
type GfSpPrimarySpIncomeDetailsRequest struct {
	// sp_id is the unique identification for sp
	SpId uint32 `protobuf:"varint,1,opt,name=sp_id,json=spId,proto3" json:"sp_id,omitempty"`
}

func (m *GfSpPrimarySpIncomeDetailsRequest) Reset()         { *m = GfSpPrimarySpIncomeDetailsRequest{} }
func (m *GfSpPrimarySpIncomeDetailsRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpPrimarySpIncomeDetailsRequest) ProtoMessage()    {}
func (*GfSpPrimarySpIncomeDetailsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{89}
}
func (m *GfSpPrimarySpIncomeDetailsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpPrimarySpIncomeDetailsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpPrimarySpIncomeDetailsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpPrimarySpIncomeDetailsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpPrimarySpIncomeDetailsRequest.Merge(m, src)
}
func (m *GfSpPrimarySpIncomeDetailsRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpPrimarySpIncomeDetailsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpPrimarySpIncomeDetailsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpPrimarySpIncomeDetailsRequest proto.InternalMessageInfo

func (m *GfSpPrimarySpIncomeDetailsRequest) GetSpId() uint32 {
	if m != nil {
		return m.SpId
	}
	return 0
...
// GfSpPrimarySpIncomeDetailsResponse is response type for the
// GfSpPrimarySpIncomeDetails RPC method
type GfSpPrimarySpIncomeDetailsResponse struct {
	...
	PrimarySpIncomeDetails []*PrimarySpIncomeDetail `protobuf:"bytes,2,rep,name=primary_sp_income_details,json=primarySpIncomeDetails,proto3" json:"primary_sp_income_details,omitempty"`
}

func (m *GfSpPrimarySpIncomeDetailsResponse) Reset()         { *m = GfSpPrimarySpIncomeDetailsResponse{} }
func (m *GfSpPrimarySpIncomeDetailsResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpPrimarySpIncomeDetailsResponse) ProtoMessage()    {}
func (*GfSpPrimarySpIncomeDetailsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{90}
}
func (m *GfSpPrimarySpIncomeDetailsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpPrimarySpIncomeDetailsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpPrimarySpIncomeDetailsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpPrimarySpIncomeDetailsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpPrimarySpIncomeDetailsResponse.Merge(m, src)
}
func (m *GfSpPrimarySpIncomeDetailsResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpPrimarySpIncomeDetailsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpPrimarySpIncomeDetailsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpPrimarySpIncomeDetailsResponse proto.InternalMessageInfo

func (m *GfSpPrimarySpIncomeDetailsResponse) GetCurrentTimestamp() int64 {
	if m != nil {
...
func (m *GfSpPrimarySpIncomeDetailsResponse) GetPrimarySpIncomeDetails() []*PrimarySpIncomeDetail {
	if m != nil {
		return m.PrimarySpIncomeDetails
	}
	return nil
}

type PrimarySpIncomeDetail struct {
	// vgf_id is the unique identification for vgf
	VgfId uint32 `protobuf:"varint,1,opt,name=vgf_id,json=vgfId,proto3" json:"vgf_id,omitempty"`
	// stream_record defines stream payment record of a stream account
	StreamRecord *types2.StreamRecord `protobuf:"bytes,2,opt,name=stream_record,json=streamRecord,proto3" json:"stream_record,omitempty"`
	// income for this primary sp
	Income cosmossdk_io_math.Int `protobuf:"bytes,3,opt,name=income,proto3,customtype=cosmossdk.io/math.Int" json:"income"`
}

func (m *PrimarySpIncomeDetail) Reset()         { *m = PrimarySpIncomeDetail{} }
func (m *PrimarySpIncomeDetail) String() string { return proto.CompactTextString(m) }
func (*PrimarySpIncomeDetail) ProtoMessage()    {}
func (*PrimarySpIncomeDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{91}
}
func (m *PrimarySpIncomeDetail) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PrimarySpIncomeDetail) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PrimarySpIncomeDetail.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PrimarySpIncomeDetail) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrimarySpIncomeDetail.Merge(m, src)
}
func (m *PrimarySpIncomeDetail) XXX_Size() int {
	return m.Size()
}
func (m *PrimarySpIncomeDetail) XXX_DiscardUnknown() {
	xxx_messageInfo_PrimarySpIncomeDetail.DiscardUnknown(m)
}

var xxx_messageInfo_PrimarySpIncomeDetail proto.InternalMessageInfo

func (m *PrimarySpIncomeDetail) GetVgfId() uint32 {
	if m != nil {
		return m.VgfId
	}
	return 0
...
func (m *PrimarySpIncomeDetail) GetStreamRecord() *types2.StreamRecord {
	if m != nil {
		return m.StreamRecord
	}
	return nil
...
// GfSpSecondarySpIncomeDetailsRequest is request type for the
// GfSpSecondarySpIncomeDetails RPC method
type GfSpSecondarySpIncomeDetailsRequest struct {
	// sp_id is the unique identification for sp
	SpId uint32 `protobuf:"varint,1,opt,name=sp_id,json=spId,proto3" json:"sp_id,omitempty"`
}

func (m *GfSpSecondarySpIncomeDetailsRequest) Reset()         { *m = GfSpSecondarySpIncomeDetailsRequest{} }
func (m *GfSpSecondarySpIncomeDetailsRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpSecondarySpIncomeDetailsRequest) ProtoMessage()    {}
func (*GfSpSecondarySpIncomeDetailsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{92}
}
func (m *GfSpSecondarySpIncomeDetailsRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpSecondarySpIncomeDetailsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpSecondarySpIncomeDetailsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpSecondarySpIncomeDetailsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpSecondarySpIncomeDetailsRequest.Merge(m, src)
}
func (m *GfSpSecondarySpIncomeDetailsRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpSecondarySpIncomeDetailsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpSecondarySpIncomeDetailsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpSecondarySpIncomeDetailsRequest proto.InternalMessageInfo

func (m *GfSpSecondarySpIncomeDetailsRequest) GetSpId() uint32 {
	if m != nil {
		return m.SpId
	}
	return 0
...
// GfSpSecondarySpIncomeDetailsResponse is response type for the
// GfSpSecondarySpIncomeDetails RPC method
type GfSpSecondarySpIncomeDetailsResponse struct {
	// current_timestamp defines the timestamp when the query happens
	CurrentTimestamp int64 `protobuf:"varint,1,opt,name=current_timestamp,json=currentTimestamp,proto3" json:"current_timestamp,omitempty"`
	// secondary_sp_income_details defines a list of SecondarySpIncomeDetail
	SecondarySpIncomeDetails []*SecondarySpIncomeDetail `protobuf:"bytes,2,rep,name=secondary_sp_income_details,json=secondarySpIncomeDetails,proto3" json:"secondary_sp_income_details,omitempty"`
}

func (m *GfSpSecondarySpIncomeDetailsResponse) Reset()         { *m = GfSpSecondarySpIncomeDetailsResponse{} }
func (m *GfSpSecondarySpIncomeDetailsResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpSecondarySpIncomeDetailsResponse) ProtoMessage()    {}
func (*GfSpSecondarySpIncomeDetailsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{93}
}
func (m *GfSpSecondarySpIncomeDetailsResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpSecondarySpIncomeDetailsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpSecondarySpIncomeDetailsResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpSecondarySpIncomeDetailsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpSecondarySpIncomeDetailsResponse.Merge(m, src)
}
func (m *GfSpSecondarySpIncomeDetailsResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpSecondarySpIncomeDetailsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpSecondarySpIncomeDetailsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpSecondarySpIncomeDetailsResponse proto.InternalMessageInfo

func (m *GfSpSecondarySpIncomeDetailsResponse) GetCurrentTimestamp() int64 {
	if m != nil {
		return m.CurrentTimestamp
	}
	return 0
...
func (m *GfSpSecondarySpIncomeDetailsResponse) GetSecondarySpIncomeDetails() []*SecondarySpIncomeDetail {
	if m != nil {
		return m.SecondarySpIncomeDetails
	}
	return nil
}

type SecondarySpIncomeDetail struct {
	// gvg_id is the unique identification for gvg
	GvgId uint32 `protobuf:"varint,1,opt,name=gvg_id,json=gvgId,proto3" json:"gvg_id,omitempty"`
	// stream_record defines stream payment record of a stream account
	StreamRecord *types2.StreamRecord `protobuf:"bytes,2,opt,name=stream_record,json=streamRecord,proto3" json:"stream_record,omitempty"`
...
func (m *SecondarySpIncomeDetail) Reset()         { *m = SecondarySpIncomeDetail{} }
func (m *SecondarySpIncomeDetail) String() string { return proto.CompactTextString(m) }
func (*SecondarySpIncomeDetail) ProtoMessage()    {}
func (*SecondarySpIncomeDetail) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{94}
}
func (m *SecondarySpIncomeDetail) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SecondarySpIncomeDetail) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SecondarySpIncomeDetail.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SecondarySpIncomeDetail) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SecondarySpIncomeDetail.Merge(m, src)
}
func (m *SecondarySpIncomeDetail) XXX_Size() int {
	return m.Size()
}
func (m *SecondarySpIncomeDetail) XXX_DiscardUnknown() {
	xxx_messageInfo_SecondarySpIncomeDetail.DiscardUnknown(m)
}

var xxx_messageInfo_SecondarySpIncomeDetail proto.InternalMessageInfo

func (m *SecondarySpIncomeDetail) GetGvgId() uint32 {
	if m != nil {
		return m.GvgId
	}
	return 0
...
func (m *SecondarySpIncomeDetail) GetStreamRecord() *types2.StreamRecord {
	if m != nil {
		return m.StreamRecord
	}
	return nil
...
type Status struct {
	...
	ManagerInfo         *ManagerInfo         `protobuf:"bytes,4,opt,name=manager_info,json=managerInfo,proto3" json:"manager_info,omitempty"`
	ExecutorInfo        *ExecutorInfo        `protobuf:"bytes,5,opt,name=executor_info,json=executorInfo,proto3" json:"executor_info,omitempty"`
	GcInfo              *GCInfo              `protobuf:"bytes,6,opt,name=gc_info,json=gcInfo,proto3" json:"gc_info,omitempty"`
}
...
func (m *Status) GetManagerInfo() *ManagerInfo {
	if m != nil {
		return m.ManagerInfo
	}
	return nil
}

func (m *Status) GetExecutorInfo() *ExecutorInfo {
	if m != nil {
...
func (m *Status) GetGcInfo() *GCInfo {
	if m != nil {
		return m.GcInfo
	}
	return nil
...
type StorageProviderInfo struct {
	...
	SpMonthlyFreeQuota uint64 `protobuf:"varint,8,opt,name=sp_monthly_free_quota,json=spMonthlyFreeQuota,proto3" json:"sp_monthly_free_quota,omitempty"`
}
...
func (m *StorageProviderInfo) GetSpMonthlyFreeQuota() uint64 {
	if m != nil {
		return m.SpMonthlyFreeQuota
	}
	return 0
}

type ManagerInfo struct {
	EnableLoadTask           bool `protobuf:"varint,1,opt,name=enable_load_task,json=enableLoadTask,proto3" json:"enable_load_task,omitempty"`
	EnableHealthChecker      bool `protobuf:"varint,2,opt,name=enable_health_checker,json=enableHealthChecker,proto3" json:"enable_health_checker,omitempty"`
	EnableTaskRetryScheduler bool `protobuf:"varint,3,opt,name=enable_task_retry_scheduler,json=enableTaskRetryScheduler,proto3" json:"enable_task_retry_scheduler,omitempty"`
}

func (m *ManagerInfo) Reset()         { *m = ManagerInfo{} }
func (m *ManagerInfo) String() string { return proto.CompactTextString(m) }
func (*ManagerInfo) ProtoMessage()    {}
func (*ManagerInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{99}
}
func (m *ManagerInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ManagerInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ManagerInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *ManagerInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ManagerInfo.Merge(m, src)
}
func (m *ManagerInfo) XXX_Size() int {
	return m.Size()
}
func (m *ManagerInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_ManagerInfo.DiscardUnknown(m)
}

var xxx_messageInfo_ManagerInfo proto.InternalMessageInfo

func (m *ManagerInfo) GetEnableLoadTask() bool {
	if m != nil {
		return m.EnableLoadTask
	}
	return false
}

func (m *ManagerInfo) GetEnableHealthChecker() bool {
	if m != nil {
		return m.EnableHealthChecker
	}
	return false
}

func (m *ManagerInfo) GetEnableTaskRetryScheduler() bool {
	if m != nil {
		return m.EnableTaskRetryScheduler
	}
	return false
}

type ExecutorInfo struct {
	ListenSealRetryTimeout   int64 `protobuf:"varint,1,opt,name=listen_seal_retry_timeout,json=listenSealRetryTimeout,proto3" json:"listen_seal_retry_timeout,omitempty"`
	BucketTrafficKeepTimeDay int64 `protobuf:"varint,2,opt,name=bucket_traffic_keep_time_day,json=bucketTrafficKeepTimeDay,proto3" json:"bucket_traffic_keep_time_day,omitempty"`
	ReadRecordKeepTimeDay    int64 `protobuf:"varint,3,opt,name=read_record_keep_time_day,json=readRecordKeepTimeDay,proto3" json:"read_record_keep_time_day,omitempty"`
}
...
func (m *ExecutorInfo) GetListenSealRetryTimeout() int64 {
	if m != nil {
		return m.ListenSealRetryTimeout
	}
	return 0
}

func (m *ExecutorInfo) GetBucketTrafficKeepTimeDay() int64 {
	if m != nil {
		return m.BucketTrafficKeepTimeDay
	}
	return 0
}

func (m *ExecutorInfo) GetReadRecordKeepTimeDay() int64 {
	if m != nil {
		return m.ReadRecordKeepTimeDay
	}
	return 0
}

type GCInfo struct {
	EnableGcZombie     bool  `protobuf:"varint,1,opt,name=enable_gc_zombie,json=enableGcZombie,proto3" json:"enable_gc_zombie,omitempty"`
	EnableGcMeta       bool  `protobuf:"varint,2,opt,name=enable_gc_meta,json=enableGcMeta,proto3" json:"enable_gc_meta,omitempty"`
	GcMetaTimeInterval int64 `protobuf:"varint,3,opt,name=gc_meta_time_interval,json=gcMetaTimeInterval,proto3" json:"gc_meta_time_interval,omitempty"`
}

func (m *GCInfo) Reset()         { *m = GCInfo{} }
func (m *GCInfo) String() string { return proto.CompactTextString(m) }
func (*GCInfo) ProtoMessage()    {}
func (*GCInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{101}
}
func (m *GCInfo) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GCInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GCInfo.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GCInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GCInfo.Merge(m, src)
}
func (m *GCInfo) XXX_Size() int {
	return m.Size()
}
func (m *GCInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_GCInfo.DiscardUnknown(m)
}

var xxx_messageInfo_GCInfo proto.InternalMessageInfo

func (m *GCInfo) GetEnableGcZombie() bool {
	if m != nil {
		return m.EnableGcZombie
	}
	return false
}

func (m *GCInfo) GetEnableGcMeta() bool {
	if m != nil {
		return m.EnableGcMeta
	}
	return false
}

func (m *GCInfo) GetGcMetaTimeInterval() int64 {
	if m != nil {
		return m.GcMetaTimeInterval
	}
	return 0
}
...
// GfSpGetUserGroupsResponse is response type for the GfSpGetUserGroups RPC
// method
...
// GfSpGetGroupMembersRequest is request type for the GfSpGetGroupMembers RPC
// method
...
// GfSpGetGroupMembersResponse is response type for the GfSpGetGroupMembers RPC
// method
...
func (*GfSpGetGroupMembersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{107}
}
...
// GfSpGetUserOwnedGroupsRequest is request type for the GfSpGetUserOwnedGroups
// RPC method
...
func (*GfSpGetUserOwnedGroupsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{108}
}
...
// GfSpGetUserOwnedGroupsResponse is response type for the
// GfSpGetUserOwnedGroups RPC method
...
func (*GfSpGetUserOwnedGroupsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{109}
}
...
func (*Policy) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{110}
}
...
// GfSpListObjectPoliciesRequest is request type for the GfSpListObjectPolicies
// RPC method
type GfSpListObjectPoliciesRequest struct {
	...
	BucketName string `protobuf:"bytes,2,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"`
	// action_type defines the requested action type of permission
	ActionType types4.ActionType `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3,enum=moca.permission.ActionType" json:"action_type,omitempty"`
	// limit sets the limit of keys returned in the response
	Limit uint32 `protobuf:"varint,4,opt,name=limit,proto3" json:"limit,omitempty"`
	// start_after is where you want to start listing from
...
func (*GfSpListObjectPoliciesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{111}
}
...
// GfSpListObjectPoliciesResponse is response type for the
// GfSpListObjectPolicies RPC method
...
func (*GfSpListObjectPoliciesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{112}
}
...
// GfSpListPaymentAccountStreamsRequest is request type for the
// GfSpListPaymentAccountStreams RPC method
...
func (*GfSpListPaymentAccountStreamsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{113}
}
...
// GfSpListPaymentAccountStreamsResponse is response type for the
// GfSpListPaymentAccountStreams RPC method
...
func (*GfSpListPaymentAccountStreamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{114}
}
...
// GfSpListUserPaymentAccountsRequest is request type for the
// GfSpListUserPaymentAccounts RPC method
...
func (*GfSpListUserPaymentAccountsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{115}
}
...
// GfSpListUserPaymentAccountsResponse is response type for the
// GfSpListUserPaymentAccounts RPC method
...
func (*GfSpListUserPaymentAccountsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{116}
}
...
// GfSpListGroupsByIDsRequest is request type for the GfSpListGroupsByIDs RPC
// method
...
func (*GfSpListGroupsByIDsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{117}
}
...
// GfSpListGroupsByIDsResponse is response type for the GfSpListGroupsByIDs RPC
// method.
...
func (*GfSpListGroupsByIDsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{118}
}
...
// GfSpGetSPMigratingBucketNumberRequest is request type for the
// GfSpGetSPMigratingBucketNumber RPC method
...
func (*GfSpGetSPMigratingBucketNumberRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{119}
}
...
// GfSpGetSPMigratingBucketNumberResponse is response type for the
// GfSpGetSPMigratingBucketNumber RPC method
...
func (*GfSpGetSPMigratingBucketNumberResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{120}
}
...
// GfSpVerifyMigrateGVGPermissionRequest is request type for the
// VerifyMigrateGVGPermission RPC method
...
func (*GfSpVerifyMigrateGVGPermissionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{121}
}
...
// GfSpVerifyMigrateGVGPermissionResponse is response type for the
// VerifyMigrateGVGPermission RPC method
...
func (*GfSpVerifyMigrateGVGPermissionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{122}
}
...
func (*GfSpGetBucketSizeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{123}
}
...
// GfSpGetBucketSizeResponse is response type for the GfSpGetBucketSize RPC
// method
...
func (*GfSpGetBucketSizeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{124}
}
...
// GfSpGetLatestObjectIDRequest is request type for the GfSpGetLatestObjectID
// RPC method
type GfSpGetLatestObjectIDRequest struct {
}

func (m *GfSpGetLatestObjectIDRequest) Reset()         { *m = GfSpGetLatestObjectIDRequest{} }
func (m *GfSpGetLatestObjectIDRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpGetLatestObjectIDRequest) ProtoMessage()    {}
func (*GfSpGetLatestObjectIDRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{125}
}
func (m *GfSpGetLatestObjectIDRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetLatestObjectIDRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetLatestObjectIDRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetLatestObjectIDRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetLatestObjectIDRequest.Merge(m, src)
}
func (m *GfSpGetLatestObjectIDRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetLatestObjectIDRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetLatestObjectIDRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetLatestObjectIDRequest proto.InternalMessageInfo

// GfSpGetLatestObjectIDResponse is response type for the GfSpGetLatestObjectID
// RPC method
type GfSpGetLatestObjectIDResponse struct {
	// object_id define latest object id
	ObjectId uint64 `protobuf:"varint,1,opt,name=object_id,json=objectId,proto3" json:"object_id,omitempty"`
}

func (m *GfSpGetLatestObjectIDResponse) Reset()         { *m = GfSpGetLatestObjectIDResponse{} }
func (m *GfSpGetLatestObjectIDResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpGetLatestObjectIDResponse) ProtoMessage()    {}
func (*GfSpGetLatestObjectIDResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{126}
}
func (m *GfSpGetLatestObjectIDResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetLatestObjectIDResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetLatestObjectIDResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetLatestObjectIDResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetLatestObjectIDResponse.Merge(m, src)
}
func (m *GfSpGetLatestObjectIDResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetLatestObjectIDResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetLatestObjectIDResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetLatestObjectIDResponse proto.InternalMessageInfo

func (m *GfSpGetLatestObjectIDResponse) GetObjectId() uint64 {
	if m != nil {
		return m.ObjectId
	}
	return 0
...
// GfSpGetBucketInfoByBucketNameRequest is request type for the
// GfSpGetBucketInfoByBucketName RPC method
type GfSpGetBucketInfoByBucketNameRequest struct {
	// bucket_name is the name of the bucket
	BucketName string `protobuf:"bytes,1,opt,name=bucket_name,json=bucketName,proto3" json:"bucket_name,omitempty"`
}

func (m *GfSpGetBucketInfoByBucketNameRequest) Reset()         { *m = GfSpGetBucketInfoByBucketNameRequest{} }
func (m *GfSpGetBucketInfoByBucketNameRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBucketInfoByBucketNameRequest) ProtoMessage()    {}
func (*GfSpGetBucketInfoByBucketNameRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{127}
}
func (m *GfSpGetBucketInfoByBucketNameRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBucketInfoByBucketNameRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBucketInfoByBucketNameRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBucketInfoByBucketNameRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBucketInfoByBucketNameRequest.Merge(m, src)
}
func (m *GfSpGetBucketInfoByBucketNameRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBucketInfoByBucketNameRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBucketInfoByBucketNameRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBucketInfoByBucketNameRequest proto.InternalMessageInfo

func (m *GfSpGetBucketInfoByBucketNameRequest) GetBucketName() string {
	if m != nil {
		return m.BucketName
	}
	return ""
...
// GfSpGetBucketInfoByBucketNameResponse is response type for the
// GfSpGetBucketInfoByBucketName RPC method.
type GfSpGetBucketInfoByBucketNameResponse struct {
	// bucket defines the information of a bucket
	Bucket *Bucket `protobuf:"bytes,1,opt,name=bucket,proto3" json:"bucket,omitempty"`
}

func (m *GfSpGetBucketInfoByBucketNameResponse) Reset()         { *m = GfSpGetBucketInfoByBucketNameResponse{} }
func (m *GfSpGetBucketInfoByBucketNameResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBucketInfoByBucketNameResponse) ProtoMessage()    {}
func (*GfSpGetBucketInfoByBucketNameResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{128}
}
func (m *GfSpGetBucketInfoByBucketNameResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBucketInfoByBucketNameResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBucketInfoByBucketNameResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBucketInfoByBucketNameResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBucketInfoByBucketNameResponse.Merge(m, src)
}
func (m *GfSpGetBucketInfoByBucketNameResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBucketInfoByBucketNameResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBucketInfoByBucketNameResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBucketInfoByBucketNameResponse proto.InternalMessageInfo

func (m *GfSpGetBucketInfoByBucketNameResponse) GetBucket() *Bucket {
	if m != nil {
		return m.Bucket
	}
	return nil
...
// GfSpGetBsDBInfoRequest  is request type for the GfSpGetBsDBInfo RPC method
type GfSpGetBsDBInfoRequest struct {
	// block height
	BlockHeight uint64 `protobuf:"varint,1,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
}

func (m *GfSpGetBsDBInfoRequest) Reset()         { *m = GfSpGetBsDBInfoRequest{} }
func (m *GfSpGetBsDBInfoRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBsDBInfoRequest) ProtoMessage()    {}
func (*GfSpGetBsDBInfoRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{129}
}
func (m *GfSpGetBsDBInfoRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBsDBInfoRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBsDBInfoRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBsDBInfoRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBsDBInfoRequest.Merge(m, src)
}
func (m *GfSpGetBsDBInfoRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBsDBInfoRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBsDBInfoRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBsDBInfoRequest proto.InternalMessageInfo

func (m *GfSpGetBsDBInfoRequest) GetBlockHeight() uint64 {
	if m != nil {
...
// GfSpGetBsDBInfoResponse  is response type for the GfSpGetBsDBInfo RPC method
type GfSpGetBsDBInfoResponse struct {
	// block height
	BlockHeight      uint64 `protobuf:"varint,1,opt,name=block_height,json=blockHeight,proto3" json:"block_height,omitempty"`
	ObjectTotalCount string `protobuf:"bytes,2,opt,name=object_total_count,json=objectTotalCount,proto3" json:"object_total_count,omitempty"`
	ObjectSealCount  string `protobuf:"bytes,3,opt,name=object_seal_count,json=objectSealCount,proto3" json:"object_seal_count,omitempty"`
}

func (m *GfSpGetBsDBInfoResponse) Reset()         { *m = GfSpGetBsDBInfoResponse{} }
func (m *GfSpGetBsDBInfoResponse) String() string { return proto.CompactTextString(m) }
func (*GfSpGetBsDBInfoResponse) ProtoMessage()    {}
func (*GfSpGetBsDBInfoResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7cdcff708e247f22, []int{130}
}
func (m *GfSpGetBsDBInfoResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpGetBsDBInfoResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpGetBsDBInfoResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpGetBsDBInfoResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpGetBsDBInfoResponse.Merge(m, src)
}
func (m *GfSpGetBsDBInfoResponse) XXX_Size() int {
	return m.Size()
}
func (m *GfSpGetBsDBInfoResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpGetBsDBInfoResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpGetBsDBInfoResponse proto.InternalMessageInfo

func (m *GfSpGetBsDBInfoResponse) GetBlockHeight() uint64 {
	if m != nil {
		return m.BlockHeight
	}
	return 0
...
func (m *GfSpGetBsDBInfoResponse) GetObjectTotalCount() string {
	if m != nil {
...
func (m *GfSpGetBsDBInfoResponse) GetObjectSealCount() string {
	if m != nil {
		return m.ObjectSealCount
	}
	return ""
}
...
func init() {
	...
	proto.RegisterType((*GfSpGetBucketReadQuotaCountRequest)(nil), "modular.metadata.types.GfSpGetBucketReadQuotaCountRequest")
	proto.RegisterType((*GfSpGetBucketReadQuotaCountResponse)(nil), "modular.metadata.types.GfSpGetBucketReadQuotaCountResponse")
	proto.RegisterType((*GfSpListBucketReadQuotaRequest)(nil), "modular.metadata.types.GfSpListBucketReadQuotaRequest")
	proto.RegisterType((*BucketReadQuotaRecord)(nil), "modular.metadata.types.BucketReadQuotaRecord")
	proto.RegisterType((*GfSpListBucketReadQuotaResponse)(nil), "modular.metadata.types.GfSpListBucketReadQuotaResponse")
	...
	proto.RegisterType((*GfSpListObjectsByIDsInternalRequest)(nil), "modular.metadata.types.GfSpListObjectsByIDsInternalRequest")
	proto.RegisterType((*GfSpListObjectsByIDsInternalResponse)(nil), "modular.metadata.types.GfSpListObjectsByIDsInternalResponse")
	proto.RegisterMapType((map[uint64]*Object)(nil), "modular.metadata.types.GfSpListObjectsByIDsInternalResponse.ObjectsEntry")
	...
	proto.RegisterType((*GfSpListCompleteMigrationBucketEventsRequest)(nil), "modular.metadata.types.GfSpListCompleteMigrationBucketEventsRequest")
	proto.RegisterType((*GfSpListCompleteMigrationBucketEventsResponse)(nil), "modular.metadata.types.GfSpListCompleteMigrationBucketEventsResponse")
	...
	proto.RegisterType((*GfSpPrimarySpIncomeDetailsRequest)(nil), "modular.metadata.types.GfSpPrimarySpIncomeDetailsRequest")
	proto.RegisterType((*GfSpPrimarySpIncomeDetailsResponse)(nil), "modular.metadata.types.GfSpPrimarySpIncomeDetailsResponse")
	proto.RegisterType((*PrimarySpIncomeDetail)(nil), "modular.metadata.types.PrimarySpIncomeDetail")
	proto.RegisterType((*GfSpSecondarySpIncomeDetailsRequest)(nil), "modular.metadata.types.GfSpSecondarySpIncomeDetailsRequest")
	proto.RegisterType((*GfSpSecondarySpIncomeDetailsResponse)(nil), "modular.metadata.types.GfSpSecondarySpIncomeDetailsResponse")
	proto.RegisterType((*SecondarySpIncomeDetail)(nil), "modular.metadata.types.SecondarySpIncomeDetail")
	...
	proto.RegisterType((*ManagerInfo)(nil), "modular.metadata.types.ManagerInfo")
	proto.RegisterType((*ExecutorInfo)(nil), "modular.metadata.types.ExecutorInfo")
	proto.RegisterType((*GCInfo)(nil), "modular.metadata.types.GCInfo")
	...
	proto.RegisterType((*GfSpGetLatestObjectIDRequest)(nil), "modular.metadata.types.GfSpGetLatestObjectIDRequest")
	proto.RegisterType((*GfSpGetLatestObjectIDResponse)(nil), "modular.metadata.types.GfSpGetLatestObjectIDResponse")
	proto.RegisterType((*GfSpGetBucketInfoByBucketNameRequest)(nil), "modular.metadata.types.GfSpGetBucketInfoByBucketNameRequest")
	proto.RegisterType((*GfSpGetBucketInfoByBucketNameResponse)(nil), "modular.metadata.types.GfSpGetBucketInfoByBucketNameResponse")
	proto.RegisterType((*GfSpGetBsDBInfoRequest)(nil), "modular.metadata.types.GfSpGetBsDBInfoRequest")
	proto.RegisterType((*GfSpGetBsDBInfoResponse)(nil), "modular.metadata.types.GfSpGetBsDBInfoResponse")
}
...
var fileDescriptor_7cdcff708e247f22 = []byte{
	...
	,
}
...
type GfSpMetadataServiceClient interface {
	...
	GfSpGetLatestObjectID(ctx context.Context, in *GfSpGetLatestObjectIDRequest, opts ...grpc.CallOption) (*GfSpGetLatestObjectIDResponse, error)
	...
	GfSpListBucketReadQuota(ctx context.Context, in *GfSpListBucketReadQuotaRequest, opts ...grpc.CallOption) (*GfSpListBucketReadQuotaResponse, error)
	GfSpGetBucketReadQuotaCount(ctx context.Context, in *GfSpGetBucketReadQuotaCountRequest, opts ...grpc.CallOption) (*GfSpGetBucketReadQuotaCountResponse, error)
	...
	// GfSpListObjectsByIDsInternal is the private-visibility counterpart of
	// GfSpListObjectsByIDs, for internal callers only.
	GfSpListObjectsByIDsInternal(ctx context.Context, in *GfSpListObjectsByIDsInternalRequest, opts ...grpc.CallOption) (*GfSpListObjectsByIDsInternalResponse, error)
	...
	GfSpListCompleteMigrationBucketEvents(ctx context.Context, in *GfSpListCompleteMigrationBucketEventsRequest, opts ...grpc.CallOption) (*GfSpListCompleteMigrationBucketEventsResponse, error)
	...
	GfSpPrimarySpIncomeDetails(ctx context.Context, in *GfSpPrimarySpIncomeDetailsRequest, opts ...grpc.CallOption) (*GfSpPrimarySpIncomeDetailsResponse, error)
	GfSpSecondarySpIncomeDetails(ctx context.Context, in *GfSpSecondarySpIncomeDetailsRequest, opts ...grpc.CallOption) (*GfSpSecondarySpIncomeDetailsResponse, error)
	GfSpGetBucketInfoByBucketName(ctx context.Context, in *GfSpGetBucketInfoByBucketNameRequest, opts ...grpc.CallOption) (*GfSpGetBucketInfoByBucketNameResponse, error)
	GfSpGetBsDBInfo(ctx context.Context, in *GfSpGetBsDBInfoRequest, opts ...grpc.CallOption) (*GfSpGetBsDBInfoResponse, error)
}
...
func (c *gfSpMetadataServiceClient) GfSpGetLatestObjectID(ctx context.Context, in *GfSpGetLatestObjectIDRequest, opts ...grpc.CallOption) (*GfSpGetLatestObjectIDResponse, error) {
	out := new(GfSpGetLatestObjectIDResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpGetLatestObjectID", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpListBucketReadQuota(ctx context.Context, in *GfSpListBucketReadQuotaRequest, opts ...grpc.CallOption) (*GfSpListBucketReadQuotaResponse, error) {
	out := new(GfSpListBucketReadQuotaResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpListBucketReadQuota", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpGetBucketReadQuotaCount(ctx context.Context, in *GfSpGetBucketReadQuotaCountRequest, opts ...grpc.CallOption) (*GfSpGetBucketReadQuotaCountResponse, error) {
	out := new(GfSpGetBucketReadQuotaCountResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpGetBucketReadQuotaCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpListObjectsByIDsInternal(ctx context.Context, in *GfSpListObjectsByIDsInternalRequest, opts ...grpc.CallOption) (*GfSpListObjectsByIDsInternalResponse, error) {
	out := new(GfSpListObjectsByIDsInternalResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpListObjectsByIDsInternal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpListCompleteMigrationBucketEvents(ctx context.Context, in *GfSpListCompleteMigrationBucketEventsRequest, opts ...grpc.CallOption) (*GfSpListCompleteMigrationBucketEventsResponse, error) {
	out := new(GfSpListCompleteMigrationBucketEventsResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpListCompleteMigrationBucketEvents", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpPrimarySpIncomeDetails(ctx context.Context, in *GfSpPrimarySpIncomeDetailsRequest, opts ...grpc.CallOption) (*GfSpPrimarySpIncomeDetailsResponse, error) {
	out := new(GfSpPrimarySpIncomeDetailsResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpPrimarySpIncomeDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpSecondarySpIncomeDetails(ctx context.Context, in *GfSpSecondarySpIncomeDetailsRequest, opts ...grpc.CallOption) (*GfSpSecondarySpIncomeDetailsResponse, error) {
	out := new(GfSpSecondarySpIncomeDetailsResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpSecondarySpIncomeDetails", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpGetBucketInfoByBucketName(ctx context.Context, in *GfSpGetBucketInfoByBucketNameRequest, opts ...grpc.CallOption) (*GfSpGetBucketInfoByBucketNameResponse, error) {
	out := new(GfSpGetBucketInfoByBucketNameResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpGetBucketInfoByBucketName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gfSpMetadataServiceClient) GfSpGetBsDBInfo(ctx context.Context, in *GfSpGetBsDBInfoRequest, opts ...grpc.CallOption) (*GfSpGetBsDBInfoResponse, error) {
	out := new(GfSpGetBsDBInfoResponse)
	err := c.cc.Invoke(ctx, "/modular.metadata.types.GfSpMetadataService/GfSpGetBsDBInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GfSpMetadataServiceServer interface {
	...
	GfSpGetLatestObjectID(context.Context, *GfSpGetLatestObjectIDRequest) (*GfSpGetLatestObjectIDResponse, error)
	...
	GfSpListBucketReadQuota(context.Context, *GfSpListBucketReadQuotaRequest) (*GfSpListBucketReadQuotaResponse, error)
	GfSpGetBucketReadQuotaCount(context.Context, *GfSpGetBucketReadQuotaCountRequest) (*GfSpGetBucketReadQuotaCountResponse, error)
	...
	// GfSpListObjectsByIDsInternal is the private-visibility counterpart of
	// GfSpListObjectsByIDs, for internal callers only.
	GfSpListObjectsByIDsInternal(context.Context, *GfSpListObjectsByIDsInternalRequest) (*GfSpListObjectsByIDsInternalResponse, error)
	...
	GfSpListCompleteMigrationBucketEvents(context.Context, *GfSpListCompleteMigrationBucketEventsRequest) (*GfSpListCompleteMigrationBucketEventsResponse, error)
	...
	GfSpPrimarySpIncomeDetails(context.Context, *GfSpPrimarySpIncomeDetailsRequest) (*GfSpPrimarySpIncomeDetailsResponse, error)
	GfSpSecondarySpIncomeDetails(context.Context, *GfSpSecondarySpIncomeDetailsRequest) (*GfSpSecondarySpIncomeDetailsResponse, error)
	GfSpGetBucketInfoByBucketName(context.Context, *GfSpGetBucketInfoByBucketNameRequest) (*GfSpGetBucketInfoByBucketNameResponse, error)
	GfSpGetBsDBInfo(context.Context, *GfSpGetBsDBInfoRequest) (*GfSpGetBsDBInfoResponse, error)
}
...
func (*UnimplementedGfSpMetadataServiceServer) GfSpGetLatestObjectID(ctx context.Context, req *GfSpGetLatestObjectIDRequest) (*GfSpGetLatestObjectIDResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpGetLatestObjectID not implemented")
}
...
func (*UnimplementedGfSpMetadataServiceServer) GfSpListBucketReadQuota(ctx context.Context, req *GfSpListBucketReadQuotaRequest) (*GfSpListBucketReadQuotaResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpListBucketReadQuota not implemented")
}
func (*UnimplementedGfSpMetadataServiceServer) GfSpGetBucketReadQuotaCount(ctx context.Context, req *GfSpGetBucketReadQuotaCountRequest) (*GfSpGetBucketReadQuotaCountResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpGetBucketReadQuotaCount not implemented")
}
...
func (*UnimplementedGfSpMetadataServiceServer) GfSpListObjectsByIDsInternal(ctx context.Context, req *GfSpListObjectsByIDsInternalRequest) (*GfSpListObjectsByIDsInternalResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpListObjectsByIDsInternal not implemented")
}
...
func (*UnimplementedGfSpMetadataServiceServer) GfSpListCompleteMigrationBucketEvents(ctx context.Context, req *GfSpListCompleteMigrationBucketEventsRequest) (*GfSpListCompleteMigrationBucketEventsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpListCompleteMigrationBucketEvents not implemented")
}
...
func (*UnimplementedGfSpMetadataServiceServer) GfSpPrimarySpIncomeDetails(ctx context.Context, req *GfSpPrimarySpIncomeDetailsRequest) (*GfSpPrimarySpIncomeDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpPrimarySpIncomeDetails not implemented")
}
func (*UnimplementedGfSpMetadataServiceServer) GfSpSecondarySpIncomeDetails(ctx context.Context, req *GfSpSecondarySpIncomeDetailsRequest) (*GfSpSecondarySpIncomeDetailsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpSecondarySpIncomeDetails not implemented")
}
func (*UnimplementedGfSpMetadataServiceServer) GfSpGetBucketInfoByBucketName(ctx context.Context, req *GfSpGetBucketInfoByBucketNameRequest) (*GfSpGetBucketInfoByBucketNameResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpGetBucketInfoByBucketName not implemented")
}
func (*UnimplementedGfSpMetadataServiceServer) GfSpGetBsDBInfo(ctx context.Context, req *GfSpGetBsDBInfoRequest) (*GfSpGetBsDBInfoResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GfSpGetBsDBInfo not implemented")
}
...
func _GfSpMetadataService_GfSpGetLatestObjectID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpGetLatestObjectIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpGetLatestObjectID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpGetLatestObjectID",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpGetLatestObjectID(ctx, req.(*GfSpGetLatestObjectIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GfSpMetadataService_GfSpListBucketReadQuota_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpListBucketReadQuotaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpListBucketReadQuota(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpListBucketReadQuota",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpListBucketReadQuota(ctx, req.(*GfSpListBucketReadQuotaRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GfSpMetadataService_GfSpGetBucketReadQuotaCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpGetBucketReadQuotaCountRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpGetBucketReadQuotaCount(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpGetBucketReadQuotaCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpGetBucketReadQuotaCount(ctx, req.(*GfSpGetBucketReadQuotaCountRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GfSpMetadataService_GfSpListObjectsByIDsInternal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpListObjectsByIDsInternalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpListObjectsByIDsInternal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpListObjectsByIDsInternal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpListObjectsByIDsInternal(ctx, req.(*GfSpListObjectsByIDsInternalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GfSpMetadataService_GfSpListCompleteMigrationBucketEvents_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpListCompleteMigrationBucketEventsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpListCompleteMigrationBucketEvents(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpListCompleteMigrationBucketEvents",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpListCompleteMigrationBucketEvents(ctx, req.(*GfSpListCompleteMigrationBucketEventsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GfSpMetadataService_GfSpPrimarySpIncomeDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpPrimarySpIncomeDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpPrimarySpIncomeDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpPrimarySpIncomeDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpPrimarySpIncomeDetails(ctx, req.(*GfSpPrimarySpIncomeDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GfSpMetadataService_GfSpSecondarySpIncomeDetails_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpSecondarySpIncomeDetailsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpSecondarySpIncomeDetails(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpSecondarySpIncomeDetails",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpSecondarySpIncomeDetails(ctx, req.(*GfSpSecondarySpIncomeDetailsRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GfSpMetadataService_GfSpGetBucketInfoByBucketName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpGetBucketInfoByBucketNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpGetBucketInfoByBucketName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpGetBucketInfoByBucketName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpGetBucketInfoByBucketName(ctx, req.(*GfSpGetBucketInfoByBucketNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _GfSpMetadataService_GfSpGetBsDBInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GfSpGetBsDBInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GfSpMetadataServiceServer).GfSpGetBsDBInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/modular.metadata.types.GfSpMetadataService/GfSpGetBsDBInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GfSpMetadataServiceServer).GfSpGetBsDBInfo(ctx, req.(*GfSpGetBsDBInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _GfSpMetadataService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GfSpGetLatestObjectID",
			Handler:    _GfSpMetadataService_GfSpGetLatestObjectID_Handler,
		},
		{
		...
		{
			MethodName: "GfSpListBucketReadQuota",
			Handler:    _GfSpMetadataService_GfSpListBucketReadQuota_Handler,
		},
		{
			MethodName: "GfSpGetBucketReadQuotaCount",
			Handler:    _GfSpMetadataService_GfSpGetBucketReadQuotaCount_Handler,
		},
		{
		...
		{
			MethodName: "GfSpListObjectsByIDsInternal",
			Handler:    _GfSpMetadataService_GfSpListObjectsByIDsInternal_Handler,
		},
		{
		...
		{
			MethodName: "GfSpListCompleteMigrationBucketEvents",
			Handler:    _GfSpMetadataService_GfSpListCompleteMigrationBucketEvents_Handler,
		},
		{
		...
		{
			MethodName: "GfSpPrimarySpIncomeDetails",
			Handler:    _GfSpMetadataService_GfSpPrimarySpIncomeDetails_Handler,
		},
		{
			MethodName: "GfSpSecondarySpIncomeDetails",
			Handler:    _GfSpMetadataService_GfSpSecondarySpIncomeDetails_Handler,
		},
		{
			MethodName: "GfSpGetBucketInfoByBucketName",
			Handler:    _GfSpMetadataService_GfSpGetBucketInfoByBucketName_Handler,
		},
		{
			MethodName: "GfSpGetBsDBInfo",
			Handler:    _GfSpMetadataService_GfSpGetBsDBInfo_Handler,
		},
	},
...
func (m *Bucket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.OffChainStatus != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.OffChainStatus))
		i--
		dAtA[i] = 0x58
	}
	if len(m.StorageSize) > 0 {
		i -= len(m.StorageSize)
		copy(dAtA[i:], m.StorageSize)
		i = encodeVarintMetadata(dAtA, i, uint64(len(m.StorageSize)))
		i--
		dAtA[i] = 0x52
	}
	if m.UpdateTime != 0 {
...
func (m *GfSpGetBucketReadQuotaResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.RemainQuotaSize != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.RemainQuotaSize))
		i--
		dAtA[i] = 0x48
	}
	if m.TotalConsumeSize != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.TotalConsumeSize))
		i--
		dAtA[i] = 0x40
	}
	if m.MonthlyFreeQuotaConsumeSize != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.MonthlyFreeQuotaConsumeSize))
		i--
		dAtA[i] = 0x38
	}
	if m.SpMonthlyFreeQuotaSize != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.SpMonthlyFreeQuotaSize))
		i--
		dAtA[i] = 0x30
	}
...
func (m *GfSpGetBucketReadQuotaCountRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBucketReadQuotaCountRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBucketReadQuotaCountRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetBucketReadQuotaCountResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBucketReadQuotaCountResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBucketReadQuotaCountResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpListBucketReadQuotaRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListBucketReadQuotaRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListBucketReadQuotaRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BucketReadQuotaRecord) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *BucketReadQuotaRecord) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *BucketReadQuotaRecord) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpListBucketReadQuotaResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListBucketReadQuotaResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListBucketReadQuotaResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpListBucketsByIDsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BucketIds) > 0 {
		dAtA30 := make([]byte, len(m.BucketIds)*10)
		var j29 int
		...
		i = encodeVarintMetadata(dAtA, i, uint64(j29))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GfSpListObjectsByIDsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ObjectIds) > 0 {
		dAtA33 := make([]byte, len(m.ObjectIds)*10)
		var j32 int
		...
		i = encodeVarintMetadata(dAtA, i, uint64(j32))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GfSpListObjectsByIDsInternalRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListObjectsByIDsInternalRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListObjectsByIDsInternalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ObjectIds) > 0 {
		dAtA36 := make([]byte, len(m.ObjectIds)*10)
		var j35 int
		for _, num := range m.ObjectIds {
			for num >= 1<<7 {
		...
		i = encodeVarintMetadata(dAtA, i, uint64(j35))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GfSpListObjectsByIDsInternalResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListObjectsByIDsInternalResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListObjectsByIDsInternalResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpListObjectsByGVGAndBucketForGCRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.DstGvgId != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.DstGvgId))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *GfSpListCompleteMigrationBucketEventsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListCompleteMigrationBucketEventsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListCompleteMigrationBucketEventsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.SrcSpId != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.SrcSpId))
		i--
		dAtA[i] = 0x10
	}
	if m.BlockId != 0 {
...
func (m *GfSpListCompleteMigrationBucketEventsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpListCompleteMigrationBucketEventsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpListCompleteMigrationBucketEventsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.CompleteEvents) > 0 {
		for iNdEx := len(m.CompleteEvents) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.CompleteEvents[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *GfSpPrimarySpIncomeDetailsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpPrimarySpIncomeDetailsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpPrimarySpIncomeDetailsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpPrimarySpIncomeDetailsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpPrimarySpIncomeDetailsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpPrimarySpIncomeDetailsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.PrimarySpIncomeDetails) > 0 {
		for iNdEx := len(m.PrimarySpIncomeDetails) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.PrimarySpIncomeDetails[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.CurrentTimestamp != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.CurrentTimestamp))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *PrimarySpIncomeDetail) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PrimarySpIncomeDetail) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PrimarySpIncomeDetail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpSecondarySpIncomeDetailsRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpSecondarySpIncomeDetailsRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSecondarySpIncomeDetailsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpSecondarySpIncomeDetailsResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpSecondarySpIncomeDetailsResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSecondarySpIncomeDetailsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.SecondarySpIncomeDetails) > 0 {
		for iNdEx := len(m.SecondarySpIncomeDetails) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.SecondarySpIncomeDetails[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SecondarySpIncomeDetail) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SecondarySpIncomeDetail) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SecondarySpIncomeDetail) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *Status) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.GcInfo != nil {
		{
			size, err := m.GcInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ManagerInfo != nil {
		{
			size, err := m.ManagerInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *StorageProviderInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.SpMonthlyFreeQuota != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.SpMonthlyFreeQuota))
		i--
		dAtA[i] = 0x40
	}
...
func (m *ManagerInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *ExecutorInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ReadRecordKeepTimeDay != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.ReadRecordKeepTimeDay))
		i--
		dAtA[i] = 0x18
	}
	if m.BucketTrafficKeepTimeDay != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.BucketTrafficKeepTimeDay))
		i--
		dAtA[i] = 0x10
	}
	if m.ListenSealRetryTimeout != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.ListenSealRetryTimeout))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *GCInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GCInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GCInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.GcMetaTimeInterval != 0 {
		i = encodeVarintMetadata(dAtA, i, uint64(m.GcMetaTimeInterval))
		i--
		dAtA[i] = 0x18
	}
	if m.EnableGcMeta {
...
func (m *GfSpListGroupsByIDsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.GroupIds) > 0 {
		dAtA62 := make([]byte, len(m.GroupIds)*10)
		var j61 int
		...
		i = encodeVarintMetadata(dAtA, i, uint64(j61))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GfSpGetLatestObjectIDRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetLatestObjectIDRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetLatestObjectIDRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetLatestObjectIDResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetLatestObjectIDResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetLatestObjectIDResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetBucketInfoByBucketNameRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBucketInfoByBucketNameRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBucketInfoByBucketNameRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetBucketInfoByBucketNameResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBucketInfoByBucketNameResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBucketInfoByBucketNameResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetBsDBInfoRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBsDBInfoRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBsDBInfoRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *GfSpGetBsDBInfoResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpGetBsDBInfoResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpGetBsDBInfoResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ObjectSealCount) > 0 {
		i -= len(m.ObjectSealCount)
		copy(dAtA[i:], m.ObjectSealCount)
		i = encodeVarintMetadata(dAtA, i, uint64(len(m.ObjectSealCount)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.ObjectTotalCount) > 0 {
		i -= len(m.ObjectTotalCount)
		copy(dAtA[i:], m.ObjectTotalCount)
		i = encodeVarintMetadata(dAtA, i, uint64(len(m.ObjectTotalCount)))
		i--
		dAtA[i] = 0x12
	}
	if m.BlockHeight != 0 {
...
func (m *Bucket) Size() (n int) {
	...
	if m.OffChainStatus != 0 {
		n += 1 + sovMetadata(uint64(m.OffChainStatus))
	}
	return n
}
...
func (m *GfSpGetBucketReadQuotaResponse) Size() (n int) {
	...
	if m.SpMonthlyFreeQuotaSize != 0 {
		n += 1 + sovMetadata(uint64(m.SpMonthlyFreeQuotaSize))
	}
	if m.MonthlyFreeQuotaConsumeSize != 0 {
		n += 1 + sovMetadata(uint64(m.MonthlyFreeQuotaConsumeSize))
	}
	if m.TotalConsumeSize != 0 {
		n += 1 + sovMetadata(uint64(m.TotalConsumeSize))
	}
	if m.RemainQuotaSize != 0 {
		n += 1 + sovMetadata(uint64(m.RemainQuotaSize))
	}
	return n
}

func (m *GfSpGetBucketReadQuotaCountRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetBucketReadQuotaCountResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpListBucketReadQuotaRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *BucketReadQuotaRecord) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpListBucketReadQuotaResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpListObjectsByIDsInternalRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpListObjectsByIDsInternalResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpListObjectsByGVGAndBucketForGCRequest) Size() (n int) {
	...
	_ = l
	if m.DstGvgId != 0 {
		n += 1 + sovMetadata(uint64(m.DstGvgId))
	}
	if m.BucketId != 0 {
		n += 1 + sovMetadata(uint64(m.BucketId))
	}
...
func (m *GfSpListCompleteMigrationBucketEventsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.SrcSpId != 0 {
		n += 1 + sovMetadata(uint64(m.SrcSpId))
	}
	return n
}

func (m *GfSpListCompleteMigrationBucketEventsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.CompleteEvents) > 0 {
		for _, e := range m.CompleteEvents {
			l = e.Size()
			n += 1 + l + sovMetadata(uint64(l))
		}
	}
...
func (m *GfSpPrimarySpIncomeDetailsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpPrimarySpIncomeDetailsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CurrentTimestamp != 0 {
		n += 1 + sovMetadata(uint64(m.CurrentTimestamp))
	}
	if len(m.PrimarySpIncomeDetails) > 0 {
		for _, e := range m.PrimarySpIncomeDetails {
			l = e.Size()
			n += 1 + l + sovMetadata(uint64(l))
		}
	}
...
func (m *PrimarySpIncomeDetail) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSecondarySpIncomeDetailsRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSecondarySpIncomeDetailsResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.SecondarySpIncomeDetails) > 0 {
		for _, e := range m.SecondarySpIncomeDetails {
			l = e.Size()
			n += 1 + l + sovMetadata(uint64(l))
		}
	}
...
func (m *SecondarySpIncomeDetail) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *StorageProviderInfo) Size() (n int) {
	...
	if m.SpMonthlyFreeQuota != 0 {
		n += 1 + sovMetadata(uint64(m.SpMonthlyFreeQuota))
	}
	return n
}
...
func (m *ExecutorInfo) Size() (n int) {
	...
	_ = l
	if m.ListenSealRetryTimeout != 0 {
		n += 1 + sovMetadata(uint64(m.ListenSealRetryTimeout))
	}
	if m.BucketTrafficKeepTimeDay != 0 {
		n += 1 + sovMetadata(uint64(m.BucketTrafficKeepTimeDay))
	}
	if m.ReadRecordKeepTimeDay != 0 {
		n += 1 + sovMetadata(uint64(m.ReadRecordKeepTimeDay))
	}
	return n
}

func (m *GCInfo) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.GcMetaTimeInterval != 0 {
		n += 1 + sovMetadata(uint64(m.GcMetaTimeInterval))
	}
	return n
}
...
func (m *GfSpGetLatestObjectIDRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetLatestObjectIDResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetBucketInfoByBucketNameRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetBucketInfoByBucketNameResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetBsDBInfoRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpGetBsDBInfoResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.ObjectTotalCount)
	if l > 0 {
		n += 1 + l + sovMetadata(uint64(l))
	}
	l = len(m.ObjectSealCount)
	if l > 0 {
		n += 1 + l + sovMetadata(uint64(l))
	}
	return n
...
func (m *Bucket) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			m.StorageSize = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OffChainStatus", wireType)
			}
			m.OffChainStatus = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OffChainStatus |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GfSpGetBucketReadQuotaResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpMonthlyFreeQuotaSize", wireType)
			}
			m.SpMonthlyFreeQuotaSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SpMonthlyFreeQuotaSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MonthlyFreeQuotaConsumeSize", wireType)
			}
			m.MonthlyFreeQuotaConsumeSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MonthlyFreeQuotaConsumeSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TotalConsumeSize", wireType)
			}
			m.TotalConsumeSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TotalConsumeSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 9:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RemainQuotaSize", wireType)
			}
			m.RemainQuotaSize = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.RemainQuotaSize |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GfSpGetBucketReadQuotaCountRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBucketReadQuotaCountRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBucketReadQuotaCountRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpGetBucketReadQuotaCountResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBucketReadQuotaCountResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBucketReadQuotaCountResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpListBucketReadQuotaRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListBucketReadQuotaRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListBucketReadQuotaRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *BucketReadQuotaRecord) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: BucketReadQuotaRecord: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: BucketReadQuotaRecord: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpListBucketReadQuotaResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListBucketReadQuotaResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListBucketReadQuotaResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.Result = append(m.Result, &BucketReadQuotaRecord{})
...
func (m *GfSpListObjectsByIDsInternalRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListObjectsByIDsInternalRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListObjectsByIDsInternalRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType == 0 {
...
func (m *GfSpListObjectsByIDsInternalResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListObjectsByIDsInternalResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListObjectsByIDsInternalResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpListObjectsByGVGAndBucketForGCRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field DstGvgId", wireType)
			}
			m.DstGvgId = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DstGvgId |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GfSpListCompleteMigrationBucketEventsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListCompleteMigrationBucketEventsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListCompleteMigrationBucketEventsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpListCompleteMigrationBucketEventsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpListCompleteMigrationBucketEventsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpListCompleteMigrationBucketEventsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.CompleteEvents = append(m.CompleteEvents, &types.EventCompleteMigrationBucket{})
			if err := m.CompleteEvents[len(m.CompleteEvents)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *GfSpPrimarySpIncomeDetailsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpPrimarySpIncomeDetailsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpPrimarySpIncomeDetailsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpPrimarySpIncomeDetailsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpPrimarySpIncomeDetailsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpPrimarySpIncomeDetailsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrimarySpIncomeDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrimarySpIncomeDetails = append(m.PrimarySpIncomeDetails, &PrimarySpIncomeDetail{})
			if err := m.PrimarySpIncomeDetails[len(m.PrimarySpIncomeDetails)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *PrimarySpIncomeDetail) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PrimarySpIncomeDetail: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PrimarySpIncomeDetail: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpSecondarySpIncomeDetailsRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpSecondarySpIncomeDetailsRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpSecondarySpIncomeDetailsRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpSecondarySpIncomeDetailsResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpSecondarySpIncomeDetailsResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpSecondarySpIncomeDetailsResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondarySpIncomeDetails", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SecondarySpIncomeDetails = append(m.SecondarySpIncomeDetails, &SecondarySpIncomeDetail{})
			if err := m.SecondarySpIncomeDetails[len(m.SecondarySpIncomeDetails)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *SecondarySpIncomeDetail) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SecondarySpIncomeDetail: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SecondarySpIncomeDetail: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *Status) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ManagerInfo", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ManagerInfo == nil {
				m.ManagerInfo = &ManagerInfo{}
			}
			if err := m.ManagerInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 5:
		...
		case 6:
			...
			if err := m.GcInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *StorageProviderInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 8:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SpMonthlyFreeQuota", wireType)
			}
			m.SpMonthlyFreeQuota = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SpMonthlyFreeQuota |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ManagerInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableLoadTask", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableLoadTask = bool(v != 0)
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableHealthChecker", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableHealthChecker = bool(v != 0)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableTaskRetryScheduler", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableTaskRetryScheduler = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(dAtA[iNdEx:])
			if err != nil {
...
func (m *ExecutorInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ListenSealRetryTimeout", wireType)
			}
			m.ListenSealRetryTimeout = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ListenSealRetryTimeout |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field BucketTrafficKeepTimeDay", wireType)
			}
			m.BucketTrafficKeepTimeDay = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.BucketTrafficKeepTimeDay |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadRecordKeepTimeDay", wireType)
			}
			m.ReadRecordKeepTimeDay = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadRecordKeepTimeDay |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GCInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GCInfo: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GCInfo: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableGcZombie", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableGcZombie = bool(v != 0)
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnableGcMeta", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnableGcMeta = bool(v != 0)
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field GcMetaTimeInterval", wireType)
			}
			m.GcMetaTimeInterval = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowMetadata
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.GcMetaTimeInterval |= int64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *GfSpGetLatestObjectIDRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetLatestObjectIDRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetLatestObjectIDRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *GfSpGetLatestObjectIDResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetLatestObjectIDResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetLatestObjectIDResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpGetBucketInfoByBucketNameRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBucketInfoByBucketNameRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBucketInfoByBucketNameRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpGetBucketInfoByBucketNameResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBucketInfoByBucketNameResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBucketInfoByBucketNameResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *GfSpGetBsDBInfoRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBsDBInfoRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBsDBInfoRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *GfSpGetBsDBInfoResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpGetBsDBInfoResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpGetBsDBInfoResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ObjectTotalCount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ObjectTotalCount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ObjectSealCount", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ObjectSealCount = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipMetadata(dAtA[iNdEx:])
