...
import (
	...
	"github.com/MocaFoundation/moca-storage-provider/base/types/gfsperrors"
	...
	modelgateway "github.com/MocaFoundation/moca-storage-provider/model/gateway"
	"github.com/MocaFoundation/moca-storage-provider/modular/downloader"
	"github.com/MocaFoundation/moca-storage-provider/modular/metadata"
	"github.com/MocaFoundation/moca-storage-provider/pkg/log"
	"github.com/MocaFoundation/moca-storage-provider/pkg/metrics"
	"github.com/MocaFoundation/moca-storage-provider/store/sqldb"
	servicetypes "github.com/MocaFoundation/moca-storage-provider/store/types"
...
func (g *GateModular) getObjectByUniversalEndpointHandler(w http.ResponseWriter, r *http.Request, isDownload bool) {
	...
	defer func() {
		...
		if err != nil {
			...
			if isRequestFromBrowser {
				...
				err = fmt.Errorf("errorCode(%s)", errorCodeForPage)
				reqCtx.SetError(gfsperrors.MakeGfSpError(err))
				reqCtx.SetHTTPCode(int(gfsperrors.MakeGfSpError(err).GetHttpStatusCode()))
				modelgateway.MakeErrorResponse(w, gfsperrors.MakeGfSpError(err))
				metrics.ReqCounter.WithLabelValues(GatewayTotalFailure).Inc()
	...
	if isPrivateObject(bucketInfo, objectInfo) {
		...
		if expiry != "" && signature != "" {
			...
			// 1. solve the account
			signedMsg := fmt.Sprintf(GnfdBuiltInDappSignedContentTemplate, "moca://"+getBucketInfoRes.GetBucketInfo().BucketName+"/"+getObjectInfoRes.GetObjectInfo().GetObjectName(), expiry)
			...
			// if !isRequestFromBrowser {
			log.CtxErrorw(reqCtx.Context(), "need param expiry and signature to authenticate user's permission")
			err = ErrForbidden
			return
			// }
			...
			// 	"moca_7971-1":    "{\n  \"envType\": \"dev\",\n  \"signedMsg\": \"Sign this message to access the file:\\n$1\\nThis signature will not cost you any fees.\\nExpiration Time: $2\",\n  \"chainId\": 7971,\n  \"chainName\": \"dev - moca\",\n  \"rpcUrls\": [\"https://gnfd-dev.qa.moca.world\"],\n  \"nativeCurrency\": { \"name\": \"amoca\", \"symbol\": \"amoca\", \"decimals\": 18 },\n  \"blockExplorerUrls\": [\"https://mocascan-qanet.fe.nodereal.cc/\"]\n}\n",
			// 	"moca_9000-1741": "{\n  \"envType\": \"qa\",\n  \"signedMsg\": \"Sign this message to access the file:\\n$1\\nThis signature will not cost you any fees.\\nExpiration Time: $2\",\n  \"chainId\": 9000,\n  \"chainName\": \"qa - moca\",\n  \"rpcUrls\": [\"https://gnfd.qa.moca.world\"],\n  \"nativeCurrency\": { \"name\": \"amoca\", \"symbol\": \"amoca\", \"decimals\": 18 },\n  \"blockExplorerUrls\": [\"https://mocascan-qanet.fe.nodereal.cc/\"]\n}\n",
			// 	"moca_5151-1":    "{\n  \"envType\": \"testnet\",\n  \"signedMsg\": \"Sign this message to access the file:\\n$1\\nThis signature will not cost you any fees.\\nExpiration Time: $2\",\n  \"chainId\": 5600,\n  \"chainName\": \"moca testnet\",\n  \"rpcUrls\": [\"https://gnfd-testnet-fullnode-tendermint-us.moca.org\"],\n  \"nativeCurrency\": { \"name\": \"amoca\", \"symbol\": \"amoca\", \"decimals\": 18 },\n  \"blockExplorerUrls\": [\"https://mocascan.com/\"]\n}\n",
			// 	"moca_920-1":     "{\n  \"envType\": \"pre-mainnet\",\n  \"signedMsg\": \"Sign this message to access the file:\\n$1\\nThis signature will not cost you any fees.\\nExpiration Time: $2\",\n  \"chainId\": 920,\n  \"chainName\": \"moca pre-main-net\",\n  \"rpcUrls\": [\"https://zk.me\"],\n  \"nativeCurrency\": { \"name\": \"amoca\", \"symbol\": \"amoca\", \"decimals\": 18 },\n  \"blockExplorerUrls\": [\"https://mocascan.com/\"]\n}\n",
			// 	"moca_5252-1":    "{\n  \"envType\": \"mainnet\",\n  \"signedMsg\": \"Sign this message to access the file:\\n$1\\nThis signature will not cost you any fees.\\nExpiration Time: $2\",\n  \"chainId\": 1017,\n  \"chainName\": \"moca main-net\",\n  \"rpcUrls\": [\"https://zk.me\"],\n  \"nativeCurrency\": { \"name\": \"amoca\", \"symbol\": \"amoca\", \"decimals\": 18 },\n  \"blockExplorerUrls\": [\"https://mocascan.com/\"]\n}\n",
			// }

			// htmlConfig := htmlConfigMap[g.baseApp.ChainID()]
			// if htmlConfig == "" {
			// 	htmlConfig = htmlConfigMap["moca_5151-1"] // use testnet by default, actually, we only need the metamask sign function, regardless which moca network the metamask is going to connect.
			// }
