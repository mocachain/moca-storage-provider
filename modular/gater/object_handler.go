...
import (
	...
	"github.com/mocachain/moca-storage-provider/modular/downloader"
	"github.com/mocachain/moca-storage-provider/modular/metadata"
	...
	for idx, pInfo := range pieceInfos {
		...
		if err != nil {
			...
			if downloaderErr.GetInnerCode() == 85101 {
				...
				task.InitRecoverPieceTask(objectInfo, params, coretask.DefaultLargerTaskPriority+1, uint32(segmentIdx), -1, maxSegmentSize, 50, 1)
