...
// Before create bucket/object to the moca, the user should the primary
...
// getChallengeInfoHandler handles get challenge piece info request. Current only moca
...
// can verify the info whether are correct by comparing with the moca info.
...
// moca validator can challenge piece whether is stored correctly. The challenge
// piece info includes: the challenged piece data, all piece hashes and the integrity hash.
// The challenger can verify the info whether are correct by comparing with the moca info.
...
// signature to seal object on moca.
