...
// params on the moca, the storage params of each object should be determined
...
// SealObjectTask is an abstract interface to record the information for sealing object on Moca chain.
