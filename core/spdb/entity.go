...
type BucketQuota struct {
	ChargedQuotaSize     uint64 // the charged quota of bucket on moca chain meta
	FreeQuotaSize        uint64 // the free quota of SP on moca chain
	MonthlyFreeQuotaSize uint64 // the monthly free quota of SP on moca chain
}
