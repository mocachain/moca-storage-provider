...
import (
	...
	types1 "github.com/mocachain/moca/v2/x/payment/types"
...
func (m *MockConsensus) ConfirmTransaction(ctx context.Context, txHash string) (*types.TxResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) ListBondedValidators(ctx context.Context) ([]types0.Validator, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) ListGlobalVirtualGroupFamilies(ctx context.Context) ([]*types4.GlobalVirtualGroupFamily, error) {
	m.ctrl.T.Helper()
...
func (mr *MockConsensusMockRecorder) ListGlobalVirtualGroupFamilies(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockConsensus) ListGlobalVirtualGroupsByFamilyID(ctx context.Context, vgfID uint32) ([]*types4.GlobalVirtualGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) ListSPs(ctx context.Context) ([]*types2.StorageProvider, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) ListVirtualGroupFamilies(ctx context.Context, spID uint32) ([]*types4.GlobalVirtualGroupFamily, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryBucketExtraInfo(ctx context.Context, bucket string) (*types3.BucketExtraInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryBucketExtraInfo", ctx, bucket)
	ret0, _ := ret[0].(*types3.BucketExtraInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryBucketExtraInfo indicates an expected call of QueryBucketExtraInfo.
func (mr *MockConsensusMockRecorder) QueryBucketExtraInfo(ctx, bucket interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockConsensus) QueryBucketInfo(ctx context.Context, bucket string) (*types3.BucketInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryBucketInfo", ctx, bucket)
	ret0, _ := ret[0].(*types3.BucketInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockConsensus) QueryBucketInfoAndObjectInfo(ctx context.Context, bucket, object string) (*types3.BucketInfo, *types3.ObjectInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryBucketInfoAndObjectInfo", ctx, bucket, object)
	ret0, _ := ret[0].(*types3.BucketInfo)
	ret1, _ := ret[1].(*types3.ObjectInfo)
	ret2, _ := ret[2].(error)
...
func (m *MockConsensus) QueryBucketInfoById(ctx context.Context, bucketId uint64) (*types3.BucketInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryGlobalVirtualGroup(ctx context.Context, gvgID uint32) (*types4.GlobalVirtualGroup, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryObjectInfo(ctx context.Context, bucket, object string) (*types3.ObjectInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryObjectInfoByID(ctx context.Context, objectID string) (*types3.ObjectInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryPaymentStreamRecord(ctx context.Context, account string) (*types1.StreamRecord, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryPaymentStreamRecord", ctx, account)
	ret0, _ := ret[0].(*types1.StreamRecord)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockConsensus) QuerySP(arg0 context.Context, arg1 string) (*types2.StorageProvider, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QuerySPByID(arg0 context.Context, arg1 uint32) (*types2.StorageProvider, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QuerySPPrice(ctx context.Context, operatorAddress string) (types2.SpStoragePrice, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QuerySPPrice", ctx, operatorAddress)
	ret0, _ := ret[0].(types2.SpStoragePrice)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockConsensus) QueryShadowObjectInfo(ctx context.Context, bucket, object string) (*types3.ShadowObjectInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QueryShadowObjectInfo", ctx, bucket, object)
	ret0, _ := ret[0].(*types3.ShadowObjectInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QueryShadowObjectInfo indicates an expected call of QueryShadowObjectInfo.
func (mr *MockConsensusMockRecorder) QueryShadowObjectInfo(ctx, bucket, object interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockConsensus) QueryStorageParams(ctx context.Context) (*types3.Params, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryStorageParamsByTimestamp(ctx context.Context, timestamp int64) (*types3.Params, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QuerySwapInInfo(ctx context.Context, familyID, gvgID uint32) (*types4.SwapInInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "QuerySwapInInfo", ctx, familyID, gvgID)
	ret0, _ := ret[0].(*types4.SwapInInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// QuerySwapInInfo indicates an expected call of QuerySwapInInfo.
func (mr *MockConsensusMockRecorder) QuerySwapInInfo(ctx, familyID, gvgID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockConsensus) QueryVirtualGroupFamily(ctx context.Context, vgfID uint32) (*types4.GlobalVirtualGroupFamily, error) {
	m.ctrl.T.Helper()
...
func (m *MockConsensus) QueryVirtualGroupParams(ctx context.Context) (*types4.Params, error) {
	m.ctrl.T.Helper()
...
func (mr *MockConsensusMockRecorder) VerifyUpdateObjectPermission(ctx, account, bucket, object interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
