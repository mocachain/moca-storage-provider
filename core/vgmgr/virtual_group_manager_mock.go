...
import (
	...
	types0 "github.com/mocachain/moca/v2/x/virtualgroup/types"
...
func (mr *MockSPPickFilterMockRecorder) Check(spID interface{}) *gomock.Call {
...
// Check indicates an expected call of Check.
func (mr *MockVGFPickFilterMockRecorder) Check(vgfID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGVGPickFilterMockRecorder) CheckFamily(familyID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGVGPickFilterMockRecorder) CheckGVG(gvgMeta interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockGenerateGVGSecondarySPsPolicyMockRecorder) AddCandidateSP(spID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockExcludeFilterMockRecorder) Apply(id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) FreezeSPAndGVGs(spID, gvgs interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) GenerateGlobalVirtualGroupMeta(genPolicy, excludeSPsFilter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) PickGlobalVirtualGroup(vgfID, excludeGVGsFilter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) PickGlobalVirtualGroupForBucketMigrate(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) PickSPByFilter(filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) PickVirtualGroupFamily(filterByGvgList interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockVirtualGroupManagerMockRecorder) QuerySPByID(spID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ReleaseAllSP mocks base method.
...
func (mr *MockVirtualGroupManagerMockRecorder) ReleaseAllSP() *gomock.Call {
	mr.mock.ctrl.T.Helper()
