...
## GfSp Framework
GfSp Framework(GfSp) is a base framework for moca storage provider. The GfSp
...
* [Consensus](./consensus/consensus.go): is the interface to query moca consensus 
...
* [BSDB](./bsdb/bsdb.go): BSDB is the interface to records the moca chain metadata.
...
* [Receiver](./module/README.md): Receiver is the modular to receive the piece data from 
  ...
  primary SP for sealing object on moca.
* [Signer](./module/README.md): Signer is the modular to handle the SP's sign and on moca 
