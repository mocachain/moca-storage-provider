...
other components in the Moca system.
...
to the primary SP for sealing on a moca.

### Signer

Signer module handles the signing of the SP data on the Moca chain operator and holds all of the SP's private keys.
