...
const (
	...
	// MinReceiveTime defines the min timeout to confirm the received piece whether is sealed on moca.
	MinReceiveTime int64 = 90
	// MaxReceiveTime defines the max timeout to confirm the received piece whether is sealed on moca.
	MaxReceiveTime int64 = 300
	// MinSealObjectTime defines the min timeout to seal object to moca.
	MinSealObjectTime int64 = 90
	// MaxSealObjectTime defines the max timeout to seal object to moca.
	...
	MaxReplicateRetry = 6
	// MinReceiveConfirmRetry defines the min retry number to confirm received piece is sealed on moca.
	MinReceiveConfirmRetry = 1
	// MaxReceiveConfirmRetry defines the max retry number to confirm received piece is sealed on moca.
