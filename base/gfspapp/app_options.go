...
import (
	...
	"github.com/mocachain/moca-storage-provider/pkg/pprof"
	"github.com/mocachain/moca-storage-provider/pkg/probe"
	"github.com/mocachain/moca-storage-provider/store/bsdb"
	"github.com/mocachain/moca-storage-provider/store/config"
	psclient "github.com/mocachain/moca-storage-provider/store/piecestore/client"
...
func DefaultGfSpConsensusOption(app *GfSpBaseApp, cfg *gfspconfig.GfSpConfig) error {
	...
	if len(cfg.Chain.RpcAddress) == 0 {
		cfg.Chain.RpcAddress = []string{DefaultRPCAddress}
	}
