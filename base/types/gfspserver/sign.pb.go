...
type GfSpSignPeerApprovalRequest struct {
	...
	//	*GfSpSignPeerApprovalRequest_SecondaryMigrationBucket
	//	*GfSpSignPeerApprovalRequest_SwapOutApproval
	Request isGfSpSignPeerApprovalRequest_Request `protobuf_oneof:"request"`
}

func (m *GfSpSignPeerApprovalRequest) Reset()         { *m = GfSpSignPeerApprovalRequest{} }
func (m *GfSpSignPeerApprovalRequest) String() string { return proto.CompactTextString(m) }
func (*GfSpSignPeerApprovalRequest) ProtoMessage()    {}
func (*GfSpSignPeerApprovalRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_16c5938400680494, []int{2}
}
func (m *GfSpSignPeerApprovalRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *GfSpSignPeerApprovalRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_GfSpSignPeerApprovalRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *GfSpSignPeerApprovalRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GfSpSignPeerApprovalRequest.Merge(m, src)
}
func (m *GfSpSignPeerApprovalRequest) XXX_Size() int {
	return m.Size()
}
func (m *GfSpSignPeerApprovalRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GfSpSignPeerApprovalRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GfSpSignPeerApprovalRequest proto.InternalMessageInfo

type isGfSpSignPeerApprovalRequest_Request interface {
	isGfSpSignPeerApprovalRequest_Request()
	MarshalTo([]byte) (int, error)
	Size() int
}

type GfSpSignPeerApprovalRequest_SecondaryMigrationBucket struct {
	SecondaryMigrationBucket *types1.SecondarySpMigrationBucketSignDoc `protobuf:"bytes,3,opt,name=secondary_migration_bucket,json=secondaryMigrationBucket,proto3,oneof" json:"secondary_migration_bucket,omitempty"`
}
type GfSpSignPeerApprovalRequest_SwapOutApproval struct {
	SwapOutApproval *types2.MsgSwapOut `protobuf:"bytes,4,opt,name=swap_out_approval,json=swapOutApproval,proto3,oneof" json:"swap_out_approval,omitempty"`
}

func (*GfSpSignPeerApprovalRequest_SecondaryMigrationBucket) isGfSpSignPeerApprovalRequest_Request() {
}
func (*GfSpSignPeerApprovalRequest_SwapOutApproval) isGfSpSignPeerApprovalRequest_Request() {}

func (m *GfSpSignPeerApprovalRequest) GetRequest() isGfSpSignPeerApprovalRequest_Request {
	if m != nil {
		return m.Request
	}
	return nil
...
func (m *GfSpSignPeerApprovalRequest) GetHost() string {
	if m != nil {
		return m.Host
	}
	return ""
...
func (m *GfSpSignPeerApprovalRequest) GetExpiryTimestamp() string {
	if m != nil {
...
func (m *GfSpSignPeerApprovalRequest) GetSecondaryMigrationBucket() *types1.SecondarySpMigrationBucketSignDoc {
	if x, ok := m.GetRequest().(*GfSpSignPeerApprovalRequest_SecondaryMigrationBucket); ok {
		return x.SecondaryMigrationBucket
	}
	return nil
}

func (m *GfSpSignPeerApprovalRequest) GetSwapOutApproval() *types2.MsgSwapOut {
	if x, ok := m.GetRequest().(*GfSpSignPeerApprovalRequest_SwapOutApproval); ok {
		return x.SwapOutApproval
	}
	return nil
}

// XXX_OneofWrappers is for the internal use of the proto package.
func (*GfSpSignPeerApprovalRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		(*GfSpSignPeerApprovalRequest_SecondaryMigrationBucket)(nil),
		(*GfSpSignPeerApprovalRequest_SwapOutApproval)(nil),
	}
}
...
type GfSpSignRequest struct {
	...
	//	*GfSpSignRequest_Deposit
	//	*GfSpSignRequest_DeleteGlobalVirtualGroup
	//	*GfSpSignRequest_ReserveSwapIn
	//	*GfSpSignRequest_CompleteSwapIn
	//	*GfSpSignRequest_CancelSwapIn
	//	*GfSpSignRequest_DelegateCreateObject
	//	*GfSpSignRequest_DelegateUpdateObjectContent
	//	*GfSpSignRequest_SealObjectInfoV2
	//	*GfSpSignRequest_PeerApprovalRequest
...
type GfSpSignRequest_Deposit struct {
	Deposit *types2.MsgDeposit `protobuf:"bytes,26,opt,name=deposit,proto3,oneof" json:"deposit,omitempty"`
}
type GfSpSignRequest_DeleteGlobalVirtualGroup struct {
	DeleteGlobalVirtualGroup *types2.MsgDeleteGlobalVirtualGroup `protobuf:"bytes,27,opt,name=delete_global_virtual_group,json=deleteGlobalVirtualGroup,proto3,oneof" json:"delete_global_virtual_group,omitempty"`
}
type GfSpSignRequest_ReserveSwapIn struct {
	ReserveSwapIn *types2.MsgReserveSwapIn `protobuf:"bytes,28,opt,name=reserve_swap_in,json=reserveSwapIn,proto3,oneof" json:"reserve_swap_in,omitempty"`
}
type GfSpSignRequest_CompleteSwapIn struct {
	CompleteSwapIn *types2.MsgCompleteSwapIn `protobuf:"bytes,29,opt,name=complete_swap_in,json=completeSwapIn,proto3,oneof" json:"complete_swap_in,omitempty"`
}
type GfSpSignRequest_CancelSwapIn struct {
	CancelSwapIn *types2.MsgCancelSwapIn `protobuf:"bytes,30,opt,name=cancel_swap_in,json=cancelSwapIn,proto3,oneof" json:"cancel_swap_in,omitempty"`
}
type GfSpSignRequest_DelegateCreateObject struct {
	DelegateCreateObject *types1.MsgDelegateCreateObject `protobuf:"bytes,31,opt,name=delegate_create_object,json=delegateCreateObject,proto3,oneof" json:"delegate_create_object,omitempty"`
}
type GfSpSignRequest_DelegateUpdateObjectContent struct {
	DelegateUpdateObjectContent *types1.MsgDelegateUpdateObjectContent `protobuf:"bytes,32,opt,name=delegate_update_object_content,json=delegateUpdateObjectContent,proto3,oneof" json:"delegate_update_object_content,omitempty"`
}
type GfSpSignRequest_SealObjectInfoV2 struct {
	SealObjectInfoV2 *types1.MsgSealObjectV2 `protobuf:"bytes,33,opt,name=seal_object_info_v2,json=sealObjectInfoV2,proto3,oneof" json:"seal_object_info_v2,omitempty"`
}
type GfSpSignRequest_PeerApprovalRequest struct {
	PeerApprovalRequest *GfSpSignPeerApprovalRequest `protobuf:"bytes,34,opt,name=peer_approval_request,json=peerApprovalRequest,proto3,oneof" json:"peer_approval_request,omitempty"`
}
...
func (*GfSpSignRequest_Deposit) isGfSpSignRequest_Request()                        {}
func (*GfSpSignRequest_DeleteGlobalVirtualGroup) isGfSpSignRequest_Request()       {}
...
func (*GfSpSignRequest_CancelSwapIn) isGfSpSignRequest_Request()                   {}
func (*GfSpSignRequest_DelegateCreateObject) isGfSpSignRequest_Request()           {}
func (*GfSpSignRequest_DelegateUpdateObjectContent) isGfSpSignRequest_Request()    {}
func (*GfSpSignRequest_SealObjectInfoV2) isGfSpSignRequest_Request()               {}
func (*GfSpSignRequest_PeerApprovalRequest) isGfSpSignRequest_Request()            {}
...
func (m *GfSpSignRequest) GetDeposit() *types2.MsgDeposit {
	if x, ok := m.GetRequest().(*GfSpSignRequest_Deposit); ok {
		return x.Deposit
	}
	return nil
}

func (m *GfSpSignRequest) GetDeleteGlobalVirtualGroup() *types2.MsgDeleteGlobalVirtualGroup {
	if x, ok := m.GetRequest().(*GfSpSignRequest_DeleteGlobalVirtualGroup); ok {
		return x.DeleteGlobalVirtualGroup
	}
	return nil
}
...
func (m *GfSpSignRequest) GetCancelSwapIn() *types2.MsgCancelSwapIn {
	if x, ok := m.GetRequest().(*GfSpSignRequest_CancelSwapIn); ok {
		return x.CancelSwapIn
	}
	return nil
}

func (m *GfSpSignRequest) GetDelegateCreateObject() *types1.MsgDelegateCreateObject {
	if x, ok := m.GetRequest().(*GfSpSignRequest_DelegateCreateObject); ok {
		return x.DelegateCreateObject
	}
	return nil
}

func (m *GfSpSignRequest) GetDelegateUpdateObjectContent() *types1.MsgDelegateUpdateObjectContent {
	if x, ok := m.GetRequest().(*GfSpSignRequest_DelegateUpdateObjectContent); ok {
		return x.DelegateUpdateObjectContent
	}
	return nil
}

func (m *GfSpSignRequest) GetSealObjectInfoV2() *types1.MsgSealObjectV2 {
	if x, ok := m.GetRequest().(*GfSpSignRequest_SealObjectInfoV2); ok {
		return x.SealObjectInfoV2
	}
	return nil
}

func (m *GfSpSignRequest) GetPeerApprovalRequest() *GfSpSignPeerApprovalRequest {
	if x, ok := m.GetRequest().(*GfSpSignRequest_PeerApprovalRequest); ok {
		return x.PeerApprovalRequest
	}
	return nil
}
...
func (*GfSpSignRequest) XXX_OneofWrappers() []interface{} {
	return []interface{}{
		...
		(*GfSpSignRequest_Deposit)(nil),
		(*GfSpSignRequest_DeleteGlobalVirtualGroup)(nil),
		(*GfSpSignRequest_ReserveSwapIn)(nil),
		(*GfSpSignRequest_CompleteSwapIn)(nil),
		(*GfSpSignRequest_CancelSwapIn)(nil),
		(*GfSpSignRequest_DelegateCreateObject)(nil),
		(*GfSpSignRequest_DelegateUpdateObjectContent)(nil),
		(*GfSpSignRequest_SealObjectInfoV2)(nil),
		(*GfSpSignRequest_PeerApprovalRequest)(nil),
	}
}
...
func (*GfSpSignResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_16c5938400680494, []int{4}
}
...
func init() {
	...
	proto.RegisterType((*GfSpSignPeerApprovalRequest)(nil), "base.types.gfspserver.GfSpSignPeerApprovalRequest")
...
var fileDescriptor_16c5938400680494 = []byte{
	...
	,
}
...
func (m *GfSpSignPeerApprovalRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *GfSpSignPeerApprovalRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignPeerApprovalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ExpiryTimestamp) > 0 {
		...
		i = encodeVarintSign(dAtA, i, uint64(len(m.ExpiryTimestamp)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Host) > 0 {
		i -= len(m.Host)
		copy(dAtA[i:], m.Host)
		i = encodeVarintSign(dAtA, i, uint64(len(m.Host)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *GfSpSignPeerApprovalRequest_SecondaryMigrationBucket) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignPeerApprovalRequest_SecondaryMigrationBucket) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SecondaryMigrationBucket != nil {
		{
			size, err := m.SecondaryMigrationBucket.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignPeerApprovalRequest_SwapOutApproval) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignPeerApprovalRequest_SwapOutApproval) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SwapOutApproval != nil {
		{
			size, err := m.SwapOutApproval.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_Deposit) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_Deposit) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Deposit != nil {
		{
			size, err := m.Deposit.MarshalToSizedBuffer(dAtA[:i])
...
func (m *GfSpSignRequest_DeleteGlobalVirtualGroup) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_DeleteGlobalVirtualGroup) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DeleteGlobalVirtualGroup != nil {
		{
			size, err := m.DeleteGlobalVirtualGroup.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_CancelSwapIn) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_CancelSwapIn) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.CancelSwapIn != nil {
		{
			size, err := m.CancelSwapIn.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_DelegateCreateObject) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_DelegateCreateObject) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DelegateCreateObject != nil {
		{
			size, err := m.DelegateCreateObject.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_DelegateUpdateObjectContent) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_DelegateUpdateObjectContent) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.DelegateUpdateObjectContent != nil {
		{
			size, err := m.DelegateUpdateObjectContent.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_SealObjectInfoV2) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_SealObjectInfoV2) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.SealObjectInfoV2 != nil {
		{
			size, err := m.SealObjectInfoV2.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignRequest_PeerApprovalRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *GfSpSignRequest_PeerApprovalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.PeerApprovalRequest != nil {
		{
			size, err := m.PeerApprovalRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *GfSpSignPeerApprovalRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSignPeerApprovalRequest_SecondaryMigrationBucket) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SecondaryMigrationBucket != nil {
		l = m.SecondaryMigrationBucket.Size()
		n += 1 + l + sovSign(uint64(l))
	}
	return n
}
func (m *GfSpSignPeerApprovalRequest_SwapOutApproval) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSignRequest_Deposit) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSignRequest_DeleteGlobalVirtualGroup) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DeleteGlobalVirtualGroup != nil {
		l = m.DeleteGlobalVirtualGroup.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
...
func (m *GfSpSignRequest_CancelSwapIn) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.CancelSwapIn != nil {
		l = m.CancelSwapIn.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
func (m *GfSpSignRequest_DelegateCreateObject) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DelegateCreateObject != nil {
		l = m.DelegateCreateObject.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
func (m *GfSpSignRequest_DelegateUpdateObjectContent) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.DelegateUpdateObjectContent != nil {
		l = m.DelegateUpdateObjectContent.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
func (m *GfSpSignRequest_SealObjectInfoV2) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.SealObjectInfoV2 != nil {
		l = m.SealObjectInfoV2.Size()
		n += 2 + l + sovSign(uint64(l))
	}
	return n
}
func (m *GfSpSignRequest_PeerApprovalRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *GfSpSignPeerApprovalRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: GfSpSignPeerApprovalRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: GfSpSignPeerApprovalRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SecondaryMigrationBucket", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Request = &GfSpSignPeerApprovalRequest_SecondaryMigrationBucket{v}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SwapOutApproval", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Request = &GfSpSignPeerApprovalRequest_SwapOutApproval{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSign(dAtA[iNdEx:])
...
func (m *GfSpSignRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			...
			m.Request = &GfSpSignRequest_Deposit{v}
			iNdEx = postIndex
		case 27:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DeleteGlobalVirtualGroup", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types2.MsgDeleteGlobalVirtualGroup{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_DeleteGlobalVirtualGroup{v}
			iNdEx = postIndex
		case 28:
			if wireType != 2 {
		...
		case 30:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CancelSwapIn", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types2.MsgCancelSwapIn{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_CancelSwapIn{v}
			iNdEx = postIndex
		case 31:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelegateCreateObject", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types1.MsgDelegateCreateObject{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_DelegateCreateObject{v}
			iNdEx = postIndex
		case 32:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field DelegateUpdateObjectContent", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types1.MsgDelegateUpdateObjectContent{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_DelegateUpdateObjectContent{v}
			iNdEx = postIndex
		case 33:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SealObjectInfoV2", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &types1.MsgSealObjectV2{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_SealObjectInfoV2{v}
			iNdEx = postIndex
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PeerApprovalRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &GfSpSignPeerApprovalRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Request = &GfSpSignRequest_PeerApprovalRequest{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipSign(dAtA[iNdEx:])
