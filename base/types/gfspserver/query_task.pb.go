...
type GfSpBucketMigrate struct {
	...
	MigratedBytesSize uint64            `protobuf:"varint,6,opt,name=migrated_bytes_size,json=migratedBytesSize,proto3" json:"migrated_bytes_size,omitempty"`
}
...
func (m *GfSpBucketMigrate) GetState() uint32 {
	if m != nil {
		return m.State
	}
	return 0
...
func (m *GfSpBucketMigrate) GetMigratedBytesSize() uint64 {
	if m != nil {
...
var fileDescriptor_35e509f6e3771557 = []byte{
	...
	,
}
...
func (m *GfSpBucketMigrate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MigratedBytesSize != 0 {
		i = encodeVarintQueryTask(dAtA, i, uint64(m.MigratedBytesSize))
		i--
		dAtA[i] = 0x30
	}
	if m.State != 0 {
		i = encodeVarintQueryTask(dAtA, i, uint64(m.State))
		i--
		dAtA[i] = 0x28
	}
	if len(m.GvgTask) > 0 {
...
func (m *GfSpBucketMigrate) Size() (n int) {
	...
	if m.State != 0 {
		n += 1 + sovQueryTask(uint64(m.State))
	}
	if m.MigratedBytesSize != 0 {
		n += 1 + sovQueryTask(uint64(m.MigratedBytesSize))
	}
	return n
}
