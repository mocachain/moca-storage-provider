...
type MetadataAPI interface {
	...
	ListBucketsByIDs(ctx context.Context, bucketIDs []uint64, includeRemoved bool, includePrivate bool, opts ...grpc.DialOption) (map[uint64]*types.Bucket, error)
	ListObjectsByIDs(ctx context.Context, objectIDs []uint64, includeRemoved bool, includePrivate bool, opts ...grpc.DialOption) (map[uint64]*types.Object, error)
