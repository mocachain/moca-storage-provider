...
const (
	...
	ReplicateObjectPiecePath = "/moca/receiver/v1/replicate-piece"
	...
	RecoveryObjectPiecePath = "/moca/recovery/v1/get-piece"
	...
	MigratePiecePath = "/moca/migrate/v1/migrate-piece"
	...
	NotifyMigrateSwapOutTaskPath = "/moca/migrate/v1/notify-migrate-swap-out-task"
	...
	SecondarySPMigrationBucketApprovalPath = "/moca/migrate/v1/migration-bucket-approval"
	// SwapOutApprovalPath defines get swap out approval path
	SwapOutApprovalPath = "/moca/migrate/v1/get-swap-out-approval"
	...
	MigrateQueryBucketQuotaPath = "/moca/migrate/v1/migrate-query-bucket-quota"
	// MigrateQueryBucketQuotaHasEnoughQuotaPath defines query bucket quota from src sp
	MigrateQueryBucketQuotaHasEnoughQuotaPath = "/moca/migrate/v1/migrate-query-bucket-has-enough-quota"
	// PreMigrateBucketPath defines pre migrate bucket, can lock quota for migrate bucket
	PreMigrateBucketPath = "/moca/migrate/v1/pre-migrate-bucket"
	// PostMigrateBucketPath defines notifying the source sp about the completion of migration bucket
	PostMigrateBucketPath = "/moca/migrate/v1/post-migrate-bucket"
